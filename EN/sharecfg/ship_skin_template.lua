...
pg.ship_skin_template = {
	...
	[101271] = {
		...
		bullet_skin_main = "",
		desc = "Hey, did you notice that ghost hovering around Bailey? The Black Witch from Planet Rabbit—— this is the new Bailey!",
		illustrator2 = -1,
		id = 101271,
		bullet_skin_secondary = "",
		no_showing = "0",
	...
	[305070] = {
		...
		name = "Kaga ",
		bullet_skin_main = "",
		desc = "2nd ship of the Tosa-class Battleships, Kaga ",
		illustrator2 = -1,
		id = 305070,
		bullet_skin_secondary = "",
		no_showing = "0",
