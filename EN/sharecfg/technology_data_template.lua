...
pg.technology_data_template = {
	{
		...
		name = "C-153-MI",
		lv_limit = 30,
		desc = "As of this point, all fundamental theories about the Wisdom Cubes are derived from the level of understanding of their basic structure. Engineers are working around to clock to further elucidate this structure.",
		condition = 0,
		bg = "1",
		blueprint_version = 1,
