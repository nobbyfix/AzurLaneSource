...
slot2.SetUnit = function (slot0, slot1)
	slot0._unit = slot1
...
slot2.UpdatePos = function (slot0, slot1)
	return
end

slot2.ConfigSkin = function (slot0, slot1)
	slot0._go = slot1
...
slot2.updatePrimalAttr = function (slot0, slot1)
...
slot2.updateBaseEnhancement = function (slot0, slot1, slot2)
...
slot2.updateSecondaryAttr = function (slot0, slot1, slot2)
...
slot2.updateBuffList = function (slot0)
...
slot2.addBuff = function (slot0, slot1)
