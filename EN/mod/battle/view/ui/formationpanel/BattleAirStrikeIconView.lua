...
function slot2.AppendIcon(slot0, slot1, slot2)
	...
	setImageSprite(slot4, uv2.Battle.BattleResourceManager:GetInstance().GetAircraftIcon(slot6, uv0.GetAircraftTmpDataFromID(slot2.templateID).icon or uv1.DEFAULT_ICON_NAME))
