...
function slot1.spawnArea(slot0, slot1)
	...
	if slot1 then
		slot0._flare = slot0._battleProxy:SpawnLastingColumnArea(slot0:GetEffectField(), slot0:GetIFF(), pg.Tool.FilterY(slot0:GetPosition():Clone()), slot0.GetTemplate().hit_type.range, time, function (slot0)
