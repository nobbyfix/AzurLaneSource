...
slot0.clearUI = function (slot0)
	...
	-- Decompilation error in this vicinity:
	--- BLOCK #10 150-154, warpins: 2 ---
	if not IsNil(slot0.baseBG) then

		-- Decompilation error in this vicinity:
		--- BLOCK #0 155-157, warpins: 1 ---
