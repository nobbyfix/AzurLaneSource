...
local function slot16(slot0, slot1)
...
local function slot17(slot0, slot1)
...
slot40 = {
	...
	gsub = function (slot0, slot1, slot2)
		...
		if not uv0[slot1] or [slot2] then
