...
slot7.magnitude = ({
	...
	Lerp = function (slot0, slot1, slot2)
		return uv1.New(slot0.x + (slot1.x - slot0.x) * uv0(slot2, 0, 1), slot0.y + (slot1.y - slot0.y) * uv0(slot2, 0, 1), slot0.z + (slot1.z - slot0.z) * uv0(slot2, 0, 1), slot0.w + (slot1.w - slot0.w) * uv0(slot2, 0, 1))
	end,
	...
	__eq = function (slot0, slot1)
		return uv0.SqrMagnitude(slot2) < 1e-10
	end
})["Magnitude"]
