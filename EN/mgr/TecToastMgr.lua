...
function pg.TecToastMgr.Show(slot0, slot1, slot2, slot3, slot4)
	...
	LeanTween.value(slot5, 0, 1, uv1.FADE_TIME):setOnUpdate(System.Action_float(slot6)):setOnComplete(System.Action(function ()
...
function pg.TecToastMgr.itemFunc(slot0, slot1, slot2, slot3)
	...
	LeanTween.value(slot1, 0, 1, uv0.FADE_TIME):setOnUpdate(System.Action_float(slot5)):setOnComplete(System.Action(function ()
