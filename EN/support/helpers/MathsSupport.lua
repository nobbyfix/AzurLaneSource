...
function math.sin16(slot0)
	...
	return slot0 * (((((-2.39e-08 * slot0 * slot0 + 2.7526e-06) * slot0 * slot0 - 0.000198409) * slot0 * slot0 + 0.0083333315) * slot0 * slot0 - 0.1666666664) * slot0 * slot0 + 1)
end
...
function math.atan16(slot0)
	...
	if uv0(slot0) > 1 then
		if FLOATSIGNBITSET(1 / slot0) then
			return -((((((((0.0028662257 * 1 / slot0 *  - 0.0161657367) * 1 / slot0 *  + 0.0429096138) * 1 / slot0 *  - 0.07528964) * 1 / slot0 *  + 0.1065626393) * 1 / slot0 *  - 0.1420889944) * 1 / slot0 *  + 0.1999355085) * 1 / slot0 *  - 0.3333314528) * 1 / slot0 *  + 1) * 1 / slot0 - uv1
		else
			return slot1 + uv1
		end
	else
