...
function slot3(slot0, slot1)
	...
	if slot2 > slot4 then
		...
		if slot2 <= slot4 or not slot2 then
			slot4 = "0"
			slot5 = slot2
			slot2 = slot4 .. slot5
		end
...
function slot7(slot0, slot1)
	...
	for slot11, slot12 in slot8, slot9, slot10 do
		...
		if slot11 >= slot14 and (slot3 ~= "" or not slot4) then
