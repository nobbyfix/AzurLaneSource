HXSet = {
	...
	update = function ()
		...
		for slot5, slot6 in pairs(pg.ship_data_statistics) do
			if slot6.nationality == Nation.JP and uv0.codeMode and uv0.codeNameMap or uv0.nameCodeMap[slot6.name] then
				slot6.name = uv0.codeMode and uv0.codeNameMap or uv0.nameCodeMap[slot6.name]
			end
