...
function slot5(slot0)
	...
	if slot27 then
		...
		if slot27 ~= "" then
			...
			slot27 = GetImageSpriteFromAtlasAsync
			slot28 = "chapter/pic/"
			...
			slot30 = 1
			slot31 = -1
			slot27 = slot27(slot28, slot29, slot30, slot31)
			slot25.uvRect = slot27
		end
	else
		slot27 = setActive
		slot28 = slot26
													...
													if slot10 == slot11 then
														...
														if slot10 == slot11 then
															...
															if slot10 == slot11 then
																...
																setActive(slot14, slot3:getRoundNum() < slot10)

																slot12:Find("Slider"):GetComponent(typeof(Slider)).value = math.max(slot3.getRoundNum() - slot10 + 3, 0) / 3
															end
														end
													end
												else
...
function slot5(slot0)
	...
	for slot6 = slot3, slot4, slot5 do
		...
		for slot10 = slot7, slot8, slot9 do
			...
			if slot11 then
				slot13 = slot11
				slot12 = slot11.IsWalkable
				slot12 = slot12(slot13)

				if slot12 then
					slot13 = slot0
					slot12 = slot0.UpdateStaticQuadCell
					slot14 = slot11
	...
	for slot7, slot8 in slot4, slot5, slot6 do
		...
		if slot15 then
			...
			if slot16 then
				...
				slot19 = slot0
				slot18 = slot0.UpdateStaticQuadCell
				slot20 = slot15
	...
	function slot6(slot0)
		...
		if slot4 == 0 then
			...
			slot4 = slot1
			slot5 = slot4
			slot4 = slot4.getChapterCell
			slot6 = slot0.row
			slot7 = slot0.column
			slot4 = slot4(slot5, slot6, slot7)
			slot5 = slot0
			slot6 = slot5
			slot5 = slot5.UpdateStaticQuadCell
			slot7 = slot4
	...
	for slot11, slot12 in slot8, slot9, slot10 do
		...
		if slot13 then
			...
			if slot14 then
				...
				slot19 = Image
				slot16 = slot16(slot17, slot18(slot19))
				slot17 = GetImageSpriteFromAtlasAsync
...
function slot6(slot0, slot1, slot2, slot3, slot4, slot5)
	...
	if slot10 > slot11 then
		...
		slot10 = slot10(slot11, slot12)
		slot12 = slot0
		slot11 = slot0.PlayParticleSystem
		slot13 = slot3
		slot14 = slot10
		slot15 = slot4
		slot16 = slot5
...
function slot6(slot0, slot1)
	...
	slot4 = slot1.column
	slot5 = ChapterCell
	slot5 = slot5.Line2QuadName
	slot6 = slot3
	slot7 = slot4
	slot5 = slot5(slot6, slot7)
	slot6 = slot0.quadRoot
	slot7 = slot6
	slot6 = slot6.Find
	slot8 = slot5
	slot6 = slot6(slot7, slot8)
	...
	if slot7 then
		...
		if slot8 then
			...
			if slot7 == "cell_enemy" then

				-- Decompilation error in this vicinity:
				--- BLOCK #0 43-53, warpins: 1 ---
				slot9 = GetImageSpriteFromAtlasAsync
				slot10 = "chapter/pic/cellgrid"
				slot11 = "cell_enemy_grid"
				slot13 = slot6
				slot12 = slot6.Find
				slot14 = "grid"
		...
		-- Decompilation error in this vicinity:
		--- BLOCK #0 65-76, warpins: 1 ---
		slot10 = slot0
		slot9 = slot0.cancelQuadTween
		slot11 = slot5
		slot12 = slot6
		...
		slot10 = slot6
		slot11 = ChapterConst
		slot11 = slot11.CellEaseOutAlpha
...
slot0.UpdateStaticQuadCell = slot6
