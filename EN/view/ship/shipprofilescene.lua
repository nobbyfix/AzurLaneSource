...
slot0.switchVoiceList = function (slot0, slot1)
...
slot0.ClearDyBg = function (slot0)
...
slot0.appendVoiceButton = function (slot0, slot1, slot2)
...
slot0.showChat = function (slot0, slot1, slot2, slot3)
	...
	-- Decompilation error in this vicinity:
	--- BLOCK #9 268-269, warpins: 1 ---
	if not slot6 then

		-- Decompilation error in this vicinity:
		--- BLOCK #0 270-270, warpins: 2 ---
		slot13 = 0
		--- END OF BLOCK #0 ---
