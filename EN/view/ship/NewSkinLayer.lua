...
function slot0.setSkin(slot0, slot1)
	...
	GetSpriteFromAtlasAsync((slot0._skinConfig.bg and #slot0._skinConfig.bg > 0 and slot0._skinConfig.bg or slot0._skinConfig.rarity_bg and #slot0._skinConfig.rarity_bg > 0 and slot0._skinConfig.rarity_bg) and "bg/star_level_bg_" .. (slot0._skinConfig.bg and #slot0._skinConfig.bg > 0 and slot0._skinConfig.bg or slot0._skinConfig.rarity_bg and #slot0._skinConfig.rarity_bg > 0 and slot0._skinConfig.rarity_bg) or "newshipbg/bg_" .. (ShipGroup.IsBluePrintGroup(pg.ship_skin_template[slot1].ship_group) and "0" or "") .. ShipRarity.Rarity2Print(pg.ship_data_statistics[slot0._skinConfig.ship_group * 10 + 1].rarity), "", function (slot0)
		setImageSprite(uv0._bg, slot0, true)
...
function slot0.openSelectPanel(slot0)
	...
	onButton(slot0, slot0.confirmChangeBtn, function ()
		...
		uv0:emit(NewSkinMediator.SET_SKIN, uv0.selectIds)
	end)
