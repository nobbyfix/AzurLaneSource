...
function slot0.initUSAccountPanel(slot0, slot1)
	...
	onButton(slot0, slot0.btnBindFacebook, function ()
		pg.UIMgr.GetInstance():LoadingOn()
		LinkSocial(AIRI_PLATFORM_FACEBOOK)
	end)
	onButton(slot0, slot0.btnUnlinkFacebook, function ()
		pg.UIMgr.GetInstance():LoadingOn()
		UnlinkSocial(AIRI_PLATFORM_FACEBOOK)
	end)
	...
	onButton(slot0, slot0.yostarSureBtn, function ()
		if getInputText(uv0.yostarEmailTxt) ~= "" and getInputText(uv0.yostarCodeTxt) ~= "" then
			pg.UIMgr.GetInstance():LoadingOn()
			LinkSocial(AIRI_PLATFORM_YOSTAR, slot0, getInputText(uv0.yostarCodeTxt))
		else
...
function slot0.checkAccountTwitterView(slot0)
	...
	if slot1 then
		setText(slot0.twitterStatus, i18n("twitter_link_title", GetSocialName(AIRI_PLATFORM_TWITTER)))
	end
end

function slot0.checkAccountFacebookView(slot0)
	slot1 = IsSocialLink(AIRI_PLATFORM_FACEBOOK)
	...
	if slot1 then
		setText(slot0.facebookStatus, i18n("facebook_link_title", GetSocialName(AIRI_PLATFORM_FACEBOOK)))
	end
end
...
function slot0.checkAccountYostarView(slot0)
	...
	if slot1 then
		setText(slot0.yostarStatus, i18n("yostar_link_title", GetSocialName(AIRI_PLATFORM_YOSTAR)))
	end
end
