function slot1(slot0)
	...
	slot0.UIlist:make(function (slot0, slot1, slot2)
		if slot0 == UIItemList.EventUpdate then
			...
			setText(slot2:Find("target/title"), uv1:getTaskById(uv0[slot1 + 1]) or uv1:getFinishTaskById(slot3) or Task.New({
				id = slot3
			}):getConfig("name"))
			...
			setActive(slot2:Find("award/mask"), uv1.getTaskById(uv0[slot1 + 1]) or uv1.getFinishTaskById(slot3) or Task.New():isReceive() or uv4 and slot3 < uv4)
		end
	end)
