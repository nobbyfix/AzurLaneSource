...
function slot0.init(slot0)
	...
	slot0.launchOneBtn = slot0:findTF("right_panel/launch_one_btn")
	slot0.launchOneBtnTxt = slot0:findTF("res/Text", slot0.launchOneBtn):GetComponent(typeof(Text))
	slot0.launchTenBtn = slot0:findTF("right_panel/launch_ten_btn")
	slot0.launchTenBtnTxt = slot0:findTF("res/Text", slot0.launchTenBtn):GetComponent(typeof(Text))
	slot0.launchMaxBtn = slot0:findTF("right_panel/launch_max_btn")
	...
	slot0.tip0 = slot0:findTF("right_panel/tip0")
	slot0.tip = slot0:findTF("right_panel/tip")
...
function slot0.didEnter(slot0)
	...
	onButton(slot0, slot0.descBtn, function ()
		...
		slot4, slot5 = uv0.showActivityPool:getItems()
	...
	setText(slot0.tip0, i18n("amercian_notice_2"))
	setText(slot0.tip, i18n("amercian_notice_3"))
...
function slot0.switchToPool(slot0, slot1)
	...
	if not slot0.bgs[slot1] then
		slot0.bgs[slot1] = LoadSprite("lotterybg/en_re_" .. slot2.index)
	end
