...
function slot0.readyToAchieve()
	...
	-- File "C:\AzurLane\Decompiler\bin\luajit-decompiler\ljd\ast\builder.py", line 856, in _build_function
	--     return _build_function_definition(prototype, state.header)
	-- File "C:\AzurLane\Decompiler\bin\luajit-decompiler\ljd\ast\builder.py", line 54, in _build_function_definition
	--     node.statements.contents = _build_function_blocks(state, instructions)
	-- File "C:\AzurLane\Decompiler\bin\luajit-decompiler\ljd\ast\builder.py", line 75, in _build_function_blocks
	--     _blockenize(state, instructions)
	-- File "C:\AzurLane\Decompiler\bin\luajit-decompiler\ljd\ast\builder.py", line 143, in _blockenize
	--     _fix_broken_unary_expressions(state, instructions)
	-- File "C:\AzurLane\Decompiler\bin\luajit-decompiler\ljd\ast\builder.py", line 1242, in _fix_broken_unary_expressions
	--     _remove_instruction(state, instructions, i + 1)
	-- File "C:\AzurLane\Decompiler\bin\luajit-decompiler\ljd\ast\builder.py", line 1265, in _remove_instruction
