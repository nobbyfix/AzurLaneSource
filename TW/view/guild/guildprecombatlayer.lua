...
slot0.displayFleetPanel = function (slot0)
	...
	slot0.fleetPanel.onCancel = function ()
		slot0:emit(GuildPreCombatMediator.SAVE, function ()
			slot0:emit(slot1.ON_CLOSE)
		end)
	end
	...
	slot0.fleetPanel.onClickShip = function (slot0)
	...
	slot0.fleetPanel.onLongPressed = function (slot0)
		slot0:emit(GuildPreCombatMediator.OPEN_SHIP_INFO, slot0.id)
	end
end

slot0.hideFleetPanel = function (slot0)
	if slot0.fleetPanel then
		slot0.fleetPanel:detach()
	end
end

slot0.displayFormation = function (slot0)
...
slot0.hideFormation = function (slot0)
	setActive(slot0.formation, false)
end
...
slot0.updateViewState = function (slot0)
...
slot0.updateDockView = function (slot0)
...
slot0.updateFriendAssist = function (slot0)
...
slot0.updateShip = function (slot0, slot1, slot2, slot3, slot4, slot5)
...
slot0.resetFlag = function (slot0)
	...
	local function slot2(slot0)
		for slot4, slot5 in ipairs(slot0) do
			if tf(slot5):Find("mouseChild") then
				slot0.eventTriggers[slot6:GetComponent("EventTriggerListener")] = true
