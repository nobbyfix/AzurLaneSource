...
slot0.updateActivityBtns = function (slot0)
	...
	-- Decompilation error in this vicinity:
	--- BLOCK #3 53-62, warpins: 2 ---
	slot7 = getProxy(ChapterProxy).getChapterById(slot6, 304)
	...
	if LOCK_SOS then
		...
		if slot7 and slot7:isClear() then
	...
	if slot1 then
		...
		if not slot2 then
			...
			-- Decompilation error in this vicinity:
			--- BLOCK #0 266-267, warpins: 2 ---
			slot19 = false

			if false then

				-- Decompilation error in this vicinity:
				--- BLOCK #0 268-268, warpins: 0 ---
				slot19 = true
				--- END OF BLOCK #0 ---
	...
	if slot1 then
		...
		if not slot2 then
			...
			-- Decompilation error in this vicinity:
			--- BLOCK #0 276-277, warpins: 1 ---
			if slot16 then

				-- Decompilation error in this vicinity:
				--- BLOCK #0 278-281, warpins: 1 ---
	...
	if not slot12 or not slot15 then
		...
		if not slot12 then
			...
			-- Decompilation error in this vicinity:
			--- BLOCK #0 312-313, warpins: 1 ---
			slot17 = false

			if false then

				-- Decompilation error in this vicinity:
				--- BLOCK #0 314-314, warpins: 0 ---
				slot17 = true
				--- END OF BLOCK #0 ---
	...
	-- Decompilation error in this vicinity:
	--- BLOCK #18 315-316, warpins: 4 ---
	if slot8 and slot1 and not slot11 and slot17 then

		-- Decompilation error in this vicinity:
		--- BLOCK #0 323-327, warpins: 1 ---
...
slot0.switchToMap = function (slot0)
	...
	if slot2 == ChapterConst.TypeSham then
		...
		-- Decompilation error in this vicinity:
		--- BLOCK #0 277-280, warpins: 1 ---
		if slot2 == ChapterConst.TypeNone then

			-- Decompilation error in this vicinity:
			--- BLOCK #0 281-292, warpins: 1 ---
			slot0:updateMapItems()
