...
ys.Battle.BattleDataProxy.HandleDamage = function (slot0, slot1, slot2, slot3)
...
ys.Battle.BattleDataProxy.HandleShipCrashDamageList = function (slot0, slot1, slot2)
	...
	for slot7, slot8 in ipairs(slot2) do
		if slot3[slot8] == nil then
			...
			slot1:AppendHostileCld(slot8, pg.TimeMgr.GetInstance():AddBattleTimer("shipCld", nil, slot0.SHIP_CLD_INTERVAL, slot9, true))
			slot9()
