...
pg.chapter_template = {
	[101] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "我方與白鷹特混航空艦隊展開一場軍事對抗演習，對方派出了最新型的精銳航空母艦，祝指揮官凱旋而歸！",
		difficulty = 2,
		avoid_ratio = 3,
		star_require_2 = 2,
		time = 99999999,
	...
	[102] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "收到急報，港口受到不明艦隊空襲，請求指揮官盡速返回支援！",
		difficulty = 3,
		avoid_ratio = 3,
		star_require_2 = 2,
		time = 43200,
	...
	[103] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "港口設施遭到嚴重破壞，亞利桑那號等戰艦大破，前方發現敵方偵查艦隊，請指揮官做好迎戰準備。",
		difficulty = 4,
		avoid_ratio = 3,
		star_require_2 = 2,
		time = 43200,
	...
	[104] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "來自東方的艦隊——重櫻，跨過大洋對我們發動了攻擊！新的大戰一觸即發！",
		difficulty = 5,
		avoid_ratio = 4,
		star_require_2 = 2,
		time = 43200,
	...
	[201] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "偵查艦隊來報珊瑚海海域發現重櫻艦隊，圖拉島上有我們的重要空軍基地，我們不能失去它！",
		difficulty = 2,
		avoid_ratio = 4,
		star_require_2 = 2,
		time = 43200,
	...
	[202] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "敵方戰機不斷來襲，我軍決定分兩路對敵方航空部隊進行搜索，請指揮官多加小心。",
		difficulty = 3,
		avoid_ratio = 4,
		star_require_2 = 2,
		time = 43200,
	...
	[203] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "前方發現落單的航母機動戰鬥群，這是千載難逢的好機會，集中火力殲滅敵方航空部隊吧！",
		difficulty = 4,
		avoid_ratio = 5,
		star_require_2 = 2,
		time = 43200,
	...
	[204] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "約克鎮和列星頓號在東南方海域受到重櫻的圍攻，我們不能失去這些寶貴的戰力。",
		difficulty = 5,
		avoid_ratio = 5,
		star_require_2 = 2,
		time = 43200,
	...
	[301] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "我方收到機密情報，重櫻集中戰鬥部隊於中途島西南方，這一次我們要來一場先發制人的戰鬥！",
		difficulty = 3,
		avoid_ratio = 6,
		star_require_2 = 2,
		time = 43200,
	...
	[302] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "我方艦載機發現了敵方的航母編隊，對方已經陣型大亂，是時候來一次漂亮的俯衝了！",
		difficulty = 4,
		avoid_ratio = 6,
		star_require_2 = 2,
		time = 43200,
	...
	[303] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "敵方航母派出的艦載機也發現了我方的航空編隊，約克鎮號受到了兩輪空襲陷入大破狀態。",
		difficulty = 5,
		avoid_ratio = 7,
		star_require_2 = 2,
		time = 43200,
	...
	[304] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "擊沉了敵方三艘正規空母，我們已經勝券在握！龍派出了最後一批轟炸機準備對我們發動最後的反擊！",
		difficulty = 6,
		avoid_ratio = 7,
		star_require_2 = 2,
		time = 43200,
	...
	[401] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "由於重櫻不斷的騷擾導致我方補給物資無法運往薩沃島，司令部派我軍執行護航任務，保證航路安全。",
		difficulty = 3,
		avoid_ratio = 8,
		star_require_2 = 2,
		time = 43200,
	...
	[402] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "在晚上的交戰中我方戰力損失慘重，馬上就要黎明，敵方主力艦隊即將抵達，請迅速撤離這片海域。",
		difficulty = 4,
		avoid_ratio = 8,
		star_require_2 = 2,
		time = 43200,
	...
	[403] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "因為在薩沃島損失巨大，司令部決定增派援軍來鞏固對所羅門海域的控制力，將重櫻的艦隊驅趕出這片海域。",
		difficulty = 5,
		avoid_ratio = 9,
		star_require_2 = 2,
		time = 43200,
	...
	[404] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "經過半天的鏖戰，我們已經追上了重櫻航母戰鬥群，對方有三艘航母，實力懸殊，請指揮官注意防空。",
		difficulty = 6,
		avoid_ratio = 9,
		star_require_2 = 2,
		time = 43200,
	...
	[601] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "重櫻為了扭轉戰局，於午夜開始發動襲擊，先遣部隊之間發生了激烈的交戰。",
		difficulty = 4,
		avoid_ratio = 12,
		star_require_2 = 2,
		time = 43200,
	...
	[602] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "有了前一次的失敗，面對本次夜戰我軍已有充足的準備，向敵人展示白鷹真正的實力吧！",
		difficulty = 5,
		avoid_ratio = 12,
		star_require_2 = 2,
		time = 43200,
	...
	[603] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "主力艦隊之間發生了激烈的交火，南達科他號受到了{namecode:73}的猛烈攻擊而陷入大破，立即前往支援！",
		difficulty = 6,
		avoid_ratio = 13,
		star_require_2 = 2,
		time = 43200,
	...
	[604] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "所羅門海域的局勢逐漸明朗，敵方為了扭轉戰局，發動了最後突擊——所羅門的噩夢，參上！",
		difficulty = 7,
		avoid_ratio = 13,
		star_require_2 = 2,
		time = 43200,
	...
	[701] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "前方偵察部隊傳來電報，重櫻艦隊企圖通過海路向瓜島運送軍需物資，司令部已經下達緊急指令要求我方前往攔截。",
		difficulty = 4,
		avoid_ratio = 14,
		star_require_2 = 2,
		time = 43200,
	...
	[702] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "報告指揮官，由於深夜航行能見度極低，重櫻艦隊已經與我方近在咫尺，這將是一場近距離的白刃戰。",
		difficulty = 5,
		avoid_ratio = 14,
		star_require_2 = 2,
		time = 43200,
	...
	[703] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "重櫻雷擊編隊已經成功迂迴到我方主力艦隊後方，水面聲納偵測到非常多的魚雷信號，請注意迴避。",
		difficulty = 6,
		avoid_ratio = 15,
		star_require_2 = 2,
		time = 43200,
	...
	[704] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "夜晚作戰對我方極為不利，重櫻已經取得了戰術上的絕對主動權，繼續接戰損失會很大，請指揮官盡快撤離這片海域。",
		difficulty = 7,
		avoid_ratio = 15,
		star_require_2 = 2,
		time = 43200,
	...
	[1090017] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "蒼藍的冰海、凜冽的寒風，蠢動的陰影、交錯的思緒……極北之北的最終試煉，願諸君武運昌隆——",
		difficulty = 10,
		avoid_ratio = 15,
		star_require_2 = 2,
		time = 43200,
	...
	[1100020] = {
		...
		enter_story_limit = "",
		star_require_3 = 3,
		profiles = "以信念突破極限，以實力突破險阻；聖域深處的最終試煉，靜候諸君——",
		difficulty = 10,
		avoid_ratio = 17,
		star_require_2 = 2,
		time = 43200,
