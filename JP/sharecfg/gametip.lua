...
に得られる「熟練度」が2倍になります]]
	...
	card_pairs_help_tip = {
		...
		tip = {
			...
			{
				info = " <color=#A1E400FF>1.毎日0:00:00に「記憶の札」の残り獲得可能枚数が＋1する（最大\n10枚入手可能）</color>"
			},
			{
			...
			{
				info = " 4.カードを全て消すと、「記憶の札」残り獲得可能枚数が0以上の場\n合、「記憶の札」を1枚入手可能（獲得可能枚数を1枚消費する）"
			},
			{
				info = " 5.カードをすべて消すと、任意の場所をタップすることで新たにゲー\nムを始めることができる"
			},
			{
				info = " 6.「記憶の札」を7枚入手すると、鳳翔のきせかえを入手可能"
			},
			{
...
・「カムバック指揮官自動召集」について
現役指揮官がイベントバナーの「自動召集」をタップす
ると、自分のUIDがカムバック指揮官の「現役指揮官
検索」で自動入力されるようになります。
・「現役指揮官自動検索」について
カムバック指揮官のイベントバナーで「現役指揮官
検索」をタップすると、前記の「自動召集」済の
指揮官のUIDを自動入力し、カムバックミッションを
始めることができます。]]
			}
		}
	},
