...
・空白絵は10月3日（木）以降開放できます。]]
	...
	link_link_help_tip = {
		...
		tip = {
			...
			{
				info = "1.「サンディエゴスター」を入手できる回数は毎日0:00に1回\n増加します；"
			},
			{
				info = "2.前日イベントに参加しなかった・ミニゲームをクリアしなかった\n場合でも回数が自動で上乗せされます；"
			},
			{
				info = "3.「サンディエゴスター」の入手個数は「何度目の入手」かに\nよって、毎回異なります；"
			},
			{
				info = "4.同じキャラアイコンをタップして、下記の条件を満たすと、\nキャラアイコンを消すことができます；"
			},
			{
				info = "5.条件：2つのキャラアイコンの間でほかのキャラアイコンを経由\nすることなく、直線（横・縦）3つ以下で繋げられる場合、キャラ\nアイコンを消すことができます；"
			},
			{
				info = "6.すべてのキャラアイコンを消すと、「サンディエゴスター」を\n入手できます；"
			},
			{
				info = "7.「サンディエゴスター」を7日間プレイして18個入手すると、\n改造素材「輝く☆マイク」を入手できます；"
			},
			{
				info = "8.「輝く☆マイク」を入手済み、もしくは「サンディエゴ改」\nを持っている場合、代わりにアイテム「サンディエゴ☆スタ\nー」を入手できます；"
			}
		}
	},
...
・「仮加入」とは：
仮加入キャラは「イベント期間中限定で」艦隊に加入し
ます。イベント終了時に「正式加入」を達成していない
場合、艦隊からいなくなります（強化や限界突破に消費
されたアイテムは返還されません）。
・「正式加入」とは：
キャラを「正式加入」させるには、「友好度」を入手し
、イベントページで各段階の「友好度報酬」を全て獲得
することにより「正式加入」させることが出来ます。

※「仮加入」キャラの機能制限：
「仮加入」状態のキャラクターは「正式加入」しない限
り、一部の機能しか利用することが出来ません。
利用可能機能：
（演習以外の）艦隊への編成、戦闘参加、強化、スキル
強化、限界突破
利用不可機能：
退役、強化素材として消費、限界突破素材として消費、
軍事委託、ケッコン、認識覚醒、秘書艦への設定、大講
堂]]
			}
		}
	},
...
限界突破について：
       ...
       1.同じ艦もしくは限界突破素材艦船を消費することで、
最大三回まで艦の性能を大きく強化できます]]
			},
			{
				info = "\n       2.限界突破は性能を上昇させるほか、\n  武器補正が上昇するなど、様々な利点があります"
			}
		}
	},
	help_shipinfo_attr = {
...
に得られる「熟練度」が2倍になります]]
	...
	shop_street_activity_tip = {
		tip = "*<color=#A1E400FF>19.10.31-19.11.13</COLOR>では<color=#A1E400FF>装備外装箱</color>が100%出現します",
	...
	card_pairs_help_tip = {
		...
		tip = {
			...
			{
				info = " <color=#A1E400FF>1.毎日0:00:00に「月餅」の残り獲得可能枚数が＋1す\nる（最大7枚入手可能）</color>"
			},
			{
			...
			{
				info = " 4.カードを全て消すと、「月餅」残り獲得可能枚数が0\n以上の場合、「月餅」を1枚入手可能（獲得可能枚数を\n1枚消費する）"
			},
			{
				info = " 5.カードをすべて消すと、任意の場所をタップすること\nで新たにゲームを始めることができる"
			},
			{
				info = " 6.「月餅」を7枚入手すると、不知火のきせかえを入手\n可能"
			},
			{
...
・当社は本機能を利用することで、他者との間でなされた情報の授受並びにその他一切の行為により生じたいかなる紛争、損害等については一切の責任を負いません。]],
	...
	word_museum_help = {
		...
		tip = {
			...
			{
				info = "    1.イベント期間中、限定任務が毎日3つ出現します。限定任務\nをクリアすると、「モデルパーツ」を入手できます。"
			},
			{
				info = "    2. 前日に限定任務を全部クリアしなかった場合、前日分の限\n定任務を全てクリアすると本日分の限定任務が出現します。"
			},
			{
				info = [[
    3.1日で限定任務をクリアできる回数は初日を除いて、毎日
0:00に3回増加します。 （前日にイベントに参加しなかった・
任務をすべてクリアしなかった場合でも数値は自動的に上乗せさ
れます。最大21回まで）]]
			},
			{
				info = "    4.「艦種」ごとのモデル修復が完了すると、報酬を入手できま\nす。"
			},
			{
				info = "    5.モデルをすべて修復すると、家具「戦艦三笠のモデル」を入\n手できます。"
			}
		}
	},
	goldship_help_tip = {
	...
	buildship_new_tip = {
		tip = "イベント期間、ガスコーニュ（μ兵装）、赤城（μ兵装）などの出現率UP！",
	...
	help_activity_bossbattle = {
		...
		tip = {
			...
			{
				info = "1.同じサーバーに所属する指揮官全員が協力し、特別ステージを\n攻略し作戦を完遂するコンテンツです；"
			},
			{
	...
	utaware_warmup_notice = {
		...
		tip = {
			...
			{
				info = [[
    1.コラボイベント期間中、メイン海域（ノーマル）3章以降の
    ステージの中枢艦隊を撃破すると、「友好度」を獲得する事が
    できます。獲得した「友好度」が一定の数値に到達すると、
    「友好度報酬」を入手することが出来ます；]]
			},
			{
				info = [[
    2.コラボキャラとして仮加入した【フミルィル】は、友好度報
    酬（7段階目）の「正式加入」を達成しない限り、ケッコンす
    ることができず、また退役や強化・限界突破素材への選択をす
    ることが出来ません；]]
			},
			{
				info = "    3.【フミルィル】を編成に入れている艦隊で上記ステージの敵\n    中枢艦隊を撃破し、かつ勝利時【フミルィル】が戦闘可能な\n    状態の場合、獲得する「友好度」が2倍になります；"
			},
			{
				info = [[
    4.イベント終了までにイベントページの「友好度報酬」を最後
    まで受け取ると、【フミルィル】を「正式加入」させることが
    できます（友好度が1500必要）。イベント終了時、「正式加
    入」していない【フミルィル】は消失します；]]
			},
			{
...
することが出来、「幸運祈願」できる回数が1回増加し
ます。ゲームクリア時の結果に応じて、入手できる景
品は変化します。
一等賞：資金150、ミルキィ饅頭1個
二等賞：資金130、ミルキィ饅頭1個
三等賞：資金110
...
より良い景品がもらえます。
また、「花火工場」で制作した花火は、イベントトッ
プ画面の「打ち上げ」をタップすることで打ち上げる
ことが出来ます。
打ち上げられた花火はイベントトップ画面から離れる
まで表示されます。
■操作方法
...
ほど、より良い景品がもらえます。
③花火を打ち上げよう
花火の制作が完了すると、イベントトップ画面で
「打ち上げ」ボタンが表示されます。
「打ち上げ」ボタンをタップすると、制作した花火が
イベントトップ画面の背景に打ち上がります。]]
			}
		}
	},
	help_summer_shrine = {
...
ンディションは増減せず、報酬を入手できません。
	...
	music_collection = {
		...
		tip = {
			...
			{
				info = [[
・11月14日（木）メンテナンスまでに「激奏のポラリス
」イベントに参加し、「Polaris」メンバーの「グッズア
イテム」を15種類全部集めると、限定家具「激奏の記念
章」を入手可能。]]
			},
			{
				info = [[
...
・受取期限　11月20日（水）23:59]]
	...
	music_main = {
		...
		tip = {
			...
			{
				info = "Live会場とは、イベント「激奏のポラリス」のトップペ\nージであり、イベンの各画面に移動する事ができます。\n"
			},
			{
				info = [[
■各コンテンツの説明
...
クリアすると、アイテム「激奏エンブレム」を集めるこ
とができます。
 
   作戦補給：
  「激奏エンブレム」を各種報酬と交換することができま
す。
 
   累計報酬：
  入手した「激奏エンブレム」の累計数により、「ジャベ
リン」のアイドルきせかえや「饅頭タイムライン」など
様々な報酬を入手出来ます。
 
   限定建造：
  建造の「期間限定建造」ページにに移動します。
 
   着せ替え：
 ショップの「着せ替え」ページに移動します。
 
   記念章：
  様々な条件を達成すことで、「ポラリスグッズ」を集め
ることができます。「ポラリスグッズ」を全部集めると、
限定アイテム「激奏記念章」を入手出来ます。
 
   激奏舞台：
  リズムゲームをプレイすることができます。７日間プレ
イすると、SR「シェフィールド（μ兵装）」を入手でき
ます。
 
  特別任務：
  イベント期間中に開放される特別任務を確認できます。
任務を全部クリアすると、「吹雪」のアイドルきせかえ
を入手出来ます。
 
  ポラリス通信：
 艦船たちの使うSNSを閲覧することができます。内容を
閲覧するには「饅頭タイムライン」を入手しておく必要
があります。また、内容は一定時間ごと投稿されます。 ]]
			}
		}
	},
	music_juus = {
		...
		tip = {
			{
				info = [[
■激奏舞台（ステージ）とは
「激奏舞台（ステージ）」とは、リズムゲームを遊び
「激奏力」を貯めるミニゲームになります。
「激奏力」は7つ貯めるとイベントページからSR「シェ
フィールド（μ兵装）」を入手できます。
「激奏力」を貯められる回数はイベント開始後1日ごとに
1回増加します。
■遊び方
...
ます。
（HARD難易度の場合、赤いアイコンは画面左側をタッ
プ、青いアイコンは画面右側をタップ、アイコンに白いラ
インがついた場合は長押しする必要があります）
