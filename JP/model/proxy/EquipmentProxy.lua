...
function slot0.register(slot0)
	...
	slot0:on(14001, function (slot0)
		...
		for slot4, slot5 in ipairs(slot0.equip_list) do
			uv0.data.equipments[Equipment.New(slot5).id] = Equipment.New(slot5)
		end

		for slot4, slot5 in ipairs(slot0.affixequipment_list) do
			uv0.data.equipments[uv0:netBuildSirenEquipment(slot5).id] = uv0.netBuildSirenEquipment(slot5)
		end
	end)
