...
ys or .MVC.Facade.escapeUpdate = function (slot0)
	slot0:GetProxyByName(uv0.Battle.BattleDataProxy.__name).UpdateEscapeOnly(slot1, slot2)
	slot0:GetMediatorByName(uv0.Battle.BattleSceneMediator.__name):UpdateEscapeOnly(uv1.TimeMgr.GetInstance():GetCombatTime())
end
