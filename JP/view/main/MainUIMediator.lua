...
slot0.ON_ACTIVITY_WOWS = "MainUIMediator:ON_ACTIVITY_WOWS"
...
slot0.updateBuildNotices = function (slot0)
	slot0.viewComponent:updateBuildNotices(getProxy(BuildShipProxy):getFinishCount())
end

slot0.updateCollectNotices = function (slot0)
...
slot0.updateSeverNotices = function (slot0)
...
slot0.onChapterTimeUp = function (slot0)
...
slot0.tryRequestVersion = function (slot0)
...
slot0.storyStorageFix = function (slot0)
	...
	slot3 = slot0:getFixStoryByStoryId({
		"WANSHENGJIE1",
		"WANSHENGJIE2",
		"WANSHENGJIE3",
		"WANSHENGJIE4",
		...
		"WANSHENGJIE6",
		"WANSHENGJIE7"
	}, slot0:getFixStoryList(5031, 5037, slot0:getFixStoryList(5001, 5020, {})))

	if getProxy(ActivityProxy):getActivityById(ActivityConst.JYHZ_ACTIVITY_ID) and not slot4:isEnd() then

		-- Decompilation error in this vicinity:
		--- BLOCK #0 48-66, warpins: 1 ---
		...
		-- Decompilation error in this vicinity:
		--- BLOCK #1 67-95, warpins: 0 ---
		for slot13 = #_.flatten(slot7), 1, -1 do

			-- Decompilation error in this vicinity:
			--- BLOCK #0 67-73, warpins: 2 ---
			if pg.task_data_template[slot8[slot13]].story_id and #slot16 > 0 then

				-- Decompilation error in this vicinity:
				--- BLOCK #0 78-83, warpins: 1 ---
				slot17 = slot6:IsPlayed(slot16)
	...
	-- Decompilation error in this vicinity:
	--- BLOCK #2 96-99, warpins: 3 ---
	if #slot3 > 0 then

		-- Decompilation error in this vicinity:
		--- BLOCK #0 100-104, warpins: 1 ---
...
slot0.getFixStoryByStoryId = function (slot0, slot1, slot2, slot3)
...
slot0.getFixStoryList = function (slot0, slot1, slot2, slot3)
