...
function slot0.register(slot0)
	...
	slot0:bind(uv0.ON_FLEET_CLEAR, function (slot0, slot1)
		uv0:getActivityFleets()[uv1.id][slot1].clearFleet(slot4)
	...
	slot0:bind(uv0.UPDATE_ACT_RANK_PT, function (slot0, slot1)
		uv0.activityProxy:getActivityByType(ActivityConst.ACTIVITY_TYPE_BOSS_RANK).data1 = slot1

		uv0.activityProxy:updateActivity(uv0.activityProxy.getActivityByType(ActivityConst.ACTIVITY_TYPE_BOSS_RANK))
	end)
