...
function slot0.filterLogs(slot0, slot1)
	slot0.contextData.page = slot1 or slot0.contextData.page or uv0.LOG_PAGE.RECENT
	slot2 = {}

	if (slot1 or slot0.contextData.page or uv0.LOG_PAGE.RECENT) == uv0.LOG_PAGE.RECENT then
