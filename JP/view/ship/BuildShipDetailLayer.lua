...
function slot0.initProjectList(slot0)
	...
	setActive(slot0.multLineTF, (slot0.MODEL == uv0 and #slot0.projectList or 0) > 0)
	setActive(slot0.singleLineTF, (slot0.MODEL == uv1 and #slot0.projectList or 0) > 0)
	slot0.multList:align(slot0.MODEL == uv0 and #slot0.projectList or 0)
	slot0.singleList:align(slot0.MODEL == uv1 and #slot0.projectList or 0)
