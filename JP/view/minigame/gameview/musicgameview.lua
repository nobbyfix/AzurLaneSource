...
slot0.game_start = function (slot0)
	...
	function slot1()
		...
		local function slot3(slot0, slot1, slot2, slot3, slot4)
			if slot1 ~= null and tonumber(slot1.begin_time) - slot2 <= slot0.musicgame_nowtime then
				if not slot0:list_pop(slot3) then
					slot0.piece_n = slot0.piece_n + 1
					slot5 = cloneTplTo(slot0.music_piece:Find("piece_" .. slot0), slot0.music_piece, slot0.piece_n)
				end

				setActive(slot5, true)
				slot0:list_push(slot4, slot6)
				slot5:GetComponent(typeof(Transform)):SetAsFirstSibling()

				if slot0.game_dgree == 1 then
				...
				if slot1.begin_time == slot1.end_time then
					if slot1.key_flag == "K_BOTH" then
						setActive(slot5:Find(slot0.game_dgree .. "/note_2"), true)

						slot5:Find(slot0.game_dgree .. "/note_2"):GetComponent(typeof(Image)).color = Color.New(1, 1, 1, 1)

						setActive(slot5:Find(slot0.game_dgree .. "/notelong_2"), false)
						setActive(slot5:Find(slot0.game_dgree .. "/note_1"), false)
						setActive(slot5:Find(slot0.game_dgree .. "/notelong_1"), false)
					else
						setActive(slot5:Find(slot0.game_dgree .. "/note_1"), true)

						slot5:Find(slot0.game_dgree .. "/note_1"):GetComponent(typeof(Image)).color = Color.New(1, 1, 1, 1)

						setActive(slot5:Find(slot0.game_dgree .. "/notelong_1"), false)
						setActive(slot5:Find(slot0.game_dgree .. "/note_2"), false)
						setActive(slot5:Find(slot0.game_dgree .. "/notelong_2"), false)
					end
				elseif slot1.key_flag == "K_BOTH" then
					setActive(slot5:Find(slot0.game_dgree .. "/note_2"), false)
					setActive(slot5:Find(slot0.game_dgree .. "/notelong_2"), true)
					setActive(slot5:Find(slot0.game_dgree .. "/note_1"), false)
					setActive(slot5:Find(slot0.game_dgree .. "/notelong_1"), false)

					slot5:Find(slot0.game_dgree .. "/notelong_2/note_above/below"):GetComponent(typeof(Image)).color = Color.New(1, 1, 1, 1)
					slot5:Find(slot0.game_dgree .. "/notelong_2/note_above/above"):GetComponent(typeof(Image)).color = Color.New(1, 1, 1, 1)
					slot7 = slot5:Find(slot0.game_dgree .. "/notelong_2/note_above"):GetComponent(typeof(RectTransform)).offsetMin
					slot8 = slot5:Find(slot0.game_dgree .. "/notelong_2/note_above"):GetComponent(typeof(RectTransform)).offsetMax
					slot9 = (274 - 1142 / slot1 * (slot1.end_time - slot1.begin_time) < 274 and slot9) or 274

					if slot0 == "left" then
						slot5:Find(slot0.game_dgree .. "/notelong_2/note_above"):GetComponent(typeof(RectTransform)).offsetMin = Vector2(slot9, slot7.y)
					elseif slot0 == "right" then
						slot5:Find(slot0.game_dgree .. "/notelong_2/note_above"):GetComponent(typeof(RectTransform)).offsetMax = Vector2(-slot9, slot8.y)
					end
				else
					setActive(slot5:Find(slot0.game_dgree .. "/note_1"), false)
					setActive(slot5:Find(slot0.game_dgree .. "/notelong_1"), true)
					setActive(slot5:Find(slot0.game_dgree .. "/note_2"), false)
					setActive(slot5:Find(slot0.game_dgree .. "/notelong_2"), false)

					slot5:Find(slot0.game_dgree .. "/notelong_1/note_above/below"):GetComponent(typeof(Image)).color = Color.New(1, 1, 1, 1)
					slot5:Find(slot0.game_dgree .. "/notelong_1/note_above/above"):GetComponent(typeof(Image)).color = Color.New(1, 1, 1, 1)
					slot7 = slot5:Find(slot0.game_dgree .. "/notelong_1/note_above"):GetComponent(typeof(RectTransform)).offsetMin
					slot8 = slot5:Find(slot0.game_dgree .. "/notelong_1/note_above"):GetComponent(typeof(RectTransform)).offsetMax
					slot9 = (274 - 1142 / slot1 * (slot1.end_time - slot1.begin_time) < 274 and slot9) or 274

					if slot0 == "left" then
						slot5:Find(slot0.game_dgree .. "/notelong_1/note_above"):GetComponent(typeof(RectTransform)).offsetMin = Vector2(slot9, slot7.y)
					elseif slot0 == "right" then
						slot5:Find(slot0.game_dgree .. "/notelong_1/note_above"):GetComponent(typeof(RectTransform)).offsetMax = Vector2(-slot9, slot8.y)
					end
				end
		...
		local function slot4(slot0, slot1, slot2, slot3)
			if slot0.game_dgree == 1 then
				if slot0 == "left" and (slot0.piece_nowl.ob or slot0.piece_nowr.ob) and slot0.downingleft_flag and not slot0.downingleft_lastflag and not slot0.piece_nowl_aloneflag then
					if slot0.piece_nowl.ob and slot0.piece_nowr.ob then
						if slot0.piece_nowl.begin_time - slot0.piece_nowr.begin_time < 0 then
							if slot0.musicgame_nowtime - slot0.piece_nowl.begin_time < slot0.time_laterperfect then
								slot0:score_update(2)
							else
								slot0:score_update(1)
							end
							...
							if slot0.musicgame_nowtime - slot0.piece_nowr.begin_time < slot0.time_laterperfect then
								slot0:score_update(2)
							else
								slot0:score_update(1)
							end
					...
					elseif slot0.piece_nowl.ob and not slot0.piece_nowr.ob then
						if slot0.musicgame_nowtime - slot0.piece_nowl.begin_time < slot0.time_laterperfect then
							slot0:score_update(2)
						else
							slot0:score_update(1)
						...
						slot0.piece_nowl.ob = false
					elseif not slot0.piece_nowl.ob and slot0.piece_nowr.ob then
						if slot0.musicgame_nowtime - slot0.piece_nowr.begin_time < slot0.time_laterperfect then
							slot0:score_update(2)
						else
							slot0:score_update(1)
					...
					slot0.piece_nowl_aloneflag = true
				elseif slot0 == "left" and slot0.piece_nowl.ob and slot0.piece_nowl.begin_time == slot0.piece_nowl.end_time and not slot0.downingleft_flag and slot0.downingleft_lastflag then
					slot0.piece_nowl_aloneflag = false
					slot0.piece_nowl_downflag = false
				elseif slot0 == "left" and ((slot0.piecelist_lt[0] ~= 0 and slot0.piecelist_lt[1].ob) or (slot0.piecelist_rt[0] ~= 0 and slot0.piecelist_rt[1].ob)) and slot0.downingleft_flag and not slot0.downingleft_lastflag then
					if slot0.piecelist_lt[0] ~= 0 and slot0.piecelist_lt[1].ob and slot0.piecelist_rt[0] ~= 0 and slot0.piecelist_rt[1].ob then
						if slot0.piecelist_lt[1].begin_time - slot0.piecelist_rt[1].begin_time < 0 then
							if slot0.piecelist_lt[1].begin_time - slot0.musicgame_nowtime < slot0.time_miss then
								if slot0.piecelist_lt[1].begin_time - slot0.musicgame_nowtime < slot0.time_good then
									if slot0.piecelist_lt[1].begin_time - slot0.musicgame_nowtime < slot0.time_perfect then
										slot0:score_update(2)
									else
										slot0:score_update(1)
									end
								else
									slot0:score_update(0)
								end

								slot0.piecelist_lt[1].ob.localPosition = slot0.pieceinit_xyz.left

								setActive(slot0.piecelist_lt[1].ob, false)
								slot0:list_push(slot0.piecelist_lf, slot0:list_pop(slot0.piecelist_lt).ob)
							end
						elseif slot0.piecelist_rt[1].begin_time - slot0.musicgame_nowtime < slot0.time_miss then
							if slot0.piecelist_rt[1].begin_time - slot0.musicgame_nowtime < slot0.time_good then
								if slot0.piecelist_rt[1].begin_time - slot0.musicgame_nowtime < slot0.time_perfect then
									slot0:score_update(2)
								else
									slot0:score_update(1)
								end
							...
							slot0.piecelist_rt[1].ob.localPosition = slot0.pieceinit_xyz.right

							setActive(slot0.piecelist_rt[1].ob, false)
							slot0:list_push(slot0.piecelist_rf, slot0:list_pop(slot0.piecelist_rt).ob)
						end
					elseif slot0.piecelist_lt[0] ~= 0 and slot0.piecelist_lt[1].ob and (slot0.piecelist_rt[0] == 0 or not slot0.piecelist_rt[1].ob) then
						if slot0.piecelist_lt[1].begin_time - slot0.musicgame_nowtime < slot0.time_miss then
							if slot0.piecelist_lt[1].begin_time - slot0.musicgame_nowtime < slot0.time_good then
								if slot0.piecelist_lt[1].begin_time - slot0.musicgame_nowtime < slot0.time_perfect then
									slot0:score_update(2)
					...
					elseif (slot0.piecelist_lt[0] == 0 or not slot0.piecelist_lt[1].ob) and slot0.piecelist_rt[0] ~= 0 and slot0.piecelist_rt[1].ob and slot0.piecelist_rt[1].begin_time - slot0.musicgame_nowtime < slot0.time_miss then
						if slot0.piecelist_rt[1].begin_time - slot0.musicgame_nowtime < slot0.time_good then
							if slot0.piecelist_rt[1].begin_time - slot0.musicgame_nowtime < slot0.time_perfect then
								slot0:score_update(2)
							else
					...
					slot0.piece_nowl_aloneflag = true
				elseif slot0 == "left" and slot2[0] ~= 0 and slot2[1].ob and slot2[1].begin_time == slot2[1].end_time and not slot0.downingleft_flag and slot0.downingleft_lastflag then
					slot0.piece_nowl_aloneflag = false
					slot0.piece_nowl_downflag = false
				elseif not slot0.downingleft_flag then
					slot0.piece_nowl_aloneflag = false
					slot0.piece_nowl_downflag = false
				end
			end
			...
			if slot0.game_dgree == 2 then
				function slot4()
					if slot0.musicgame_nowtime - slot0.piece_nowl.begin_time < slot0.time_laterperfect then
						slot0:score_update(2)
					elseif slot0.musicgame_nowtime - slot0.piece_nowl.begin_time < slot0.time_latergood then
						slot0:score_update(1)
					end
					...
					setActive(slot0.piece_nowl.ob, false)
					setActive:list_push(slot0.piecelist_lf, slot0.piece_nowl.ob)

					setActive.list_push.piece_nowl.ob = false
					setActive.list_push.piece_nowl.piece_nowl_aloneflag = true
				end

				function slot5()
					if slot0.musicgame_nowtime - slot0.piece_nowr.begin_time < slot0.time_laterperfect then
						slot0:score_update(2)
					elseif slot0.musicgame_nowtime - slot0.piece_nowr.begin_time < slot0.time_latergood then
						slot0:score_update(1)
					end
					...
					setActive(slot0.piece_nowr.ob, false)
					setActive:list_push(slot0.piecelist_rf, slot0.piece_nowr.ob)

					setActive.list_push.piece_nowr.ob = false
					setActive.list_push.piece_nowr.piece_nowr_aloneflag = true
				end
				...
				function slot6()
					if slot0.piecelist_lt[1].begin_time - slot0.musicgame_nowtime < slot0.time_miss then
						...
						setActive(slot0.piecelist_lt[1].ob, false)
						setActive:list_push(slot0.piecelist_lf, slot0:list_pop(slot0.piecelist_lt).ob)

						setActive.list_push.piece_nowl_aloneflag = true
					end
				end

				function slot7()
					if slot0.piecelist_rt[1].begin_time - slot0.musicgame_nowtime < slot0.time_miss then
						if slot0.piecelist_rt[1].begin_time - slot0.musicgame_nowtime < slot0.time_good then
							if slot0.piecelist_rt[1].begin_time - slot0.musicgame_nowtime < slot0.time_perfect then
								slot0:score_update(2)
							else
						...
						setActive(slot0.piecelist_rt[1].ob, false)
						setActive:list_push(slot0.piecelist_rf, slot0:list_pop(slot0.piecelist_rt).ob)

						setActive.list_push.piece_nowr_aloneflag = true
					end
				end

				function slot8()
					if slot0.musicgame_nowtime - slot0.piece_nowl.begin_time <= slot0.time_laterperfect then
						if not slot0.piece_nowl_downflag then
							slot0.piece_nowl_downflag = true

							slot0:score_update(2)
						end
					elseif slot0.musicgame_nowtime - slot0.piece_nowl.begin_time <= slot0.time_latergood and not slot0.piece_nowl_downflag then
						slot0.piece_nowl_downflag = true

						slot0:score_update(1)
					end

					if slot0.musicgame_nowtime - slot0.piece_nowl.end_time > slot0.time_latergood - slot0.time_interval and slot0.piece_nowl_downflag then
						slot0.piece_nowl_downflag = false
				...
				function slot9()
					if slot0.musicgame_nowtime - slot0.piece_nowr.begin_time <= slot0.time_laterperfect then
						if not slot0.piece_nowr_downflag then
							slot0.piece_nowr_downflag = true

							slot0:score_update(2)
						end
					elseif slot0.musicgame_nowtime - slot0.piece_nowr.begin_time <= slot0.time_latergood and not slot0.piece_nowr_downflag then
						slot0.piece_nowr_downflag = true

						slot0:score_update(1)
					end

					if slot0.musicgame_nowtime - slot0.piece_nowr.end_time > slot0.time_latergood - slot0.time_interval and slot0.piece_nowr_downflag then
						slot0.piece_nowr_downflag = false
				...
				function slot10()
					if slot0.piece_nowl.end_time - slot0.musicgame_nowtime < slot0.time_good and slot0.piece_nowl_downflag and slot0.musicgame_nowtime - slot0.piece_nowl.end_time < slot0.time_latergood then
						if slot0.piece_nowl.end_time - slot0.musicgame_nowtime < slot0.time_perfect and slot0.musicgame_nowtime - slot0.piece_nowl.end_time < slot0.time_laterperfect then
							slot0:score_update(2)
						else
							slot0:score_update(1)
						end
					...
					setActive.list_push.piece_nowl.ob = false
					setActive.list_push.piece_nowl.piece_nowl_downflag = false
					setActive.list_push.piece_nowl.piece_nowl_aloneflag = false
				end

				function slot11()
					if slot0.piece_nowr.end_time - slot0.musicgame_nowtime < slot0.time_good and slot0.piece_nowr_downflag and slot0.musicgame_nowtime - slot0.piece_nowr.end_time < slot0.time_latergood then
						if slot0.piece_nowr.end_time - slot0.musicgame_nowtime < slot0.time_perfect and slot0.musicgame_nowtime - slot0.piece_nowr.end_time < slot0.time_laterperfect then
							slot0:score_update(2)
						else
							slot0:score_update(1)
						end
					...
					setActive.list_push.piece_nowr.ob = false
					setActive.list_push.piece_nowr.piece_nowr_downflag = false
					setActive.list_push.piece_nowr.piece_nowr_aloneflag = false
				end

				function slot12()
					if slot0.musicgame_nowtime - slot0.piece_nowl.begin_time > slot0.time_latergood - slot0.time_interval then
						slot0.piece_nowl_downflag = false
						slot0.piece_nowl.ob.localPosition = slot0.pieceinit_xyz.left
						...
						setActive.list_push.piece_nowl:score_update(0)
						setActive.list_push.piece_nowl.score_update:score_update(0)
					end
				end

				function slot13()
					if slot0.musicgame_nowtime - slot0.piece_nowr.begin_time > slot0.time_latergood - slot0.time_interval then
						slot0.piece_nowr_downflag = false
						slot0.piece_nowr.ob.localPosition = slot0.pieceinit_xyz.right
						...
						setActive.list_push.piece_nowr:score_update(0)
						setActive.list_push.piece_nowr.score_update:score_update(0)
					end
				end

				function slot14()
					if slot1.musicgame_nowtime.time_good < slot0[1].begin_time - slot1.musicgame_nowtime and slot0[1].begin_time - slot1.musicgame_nowtime < slot1.musicgame_nowtime.time_miss then
						slot0[1].ob.localPosition = slot1.pieceinit_xyz.left

						setActive(slot0[1].ob, false)
						slot0[1].ob:list_push(slot1.piecelist_lf, slot1:list_pop(slot0[1].ob.list_push).ob)

						slot0[1].ob.piece_nowl_downflag = false

						false:score_update(0)
						false:score_update(0)
					end
				end
				...
				function slot15()
					if slot1.musicgame_nowtime.time_good < slot0[1].begin_time - slot1.musicgame_nowtime and slot0[1].begin_time - slot1.musicgame_nowtime < slot1.musicgame_nowtime.time_miss then
						slot0[1].ob.localPosition = slot1.pieceinit_xyz.right

						setActive(slot0[1].ob, false)
						slot0[1].ob:list_push(slot1.piecelist_rf, slot1:list_pop(slot0[1].ob.list_push).ob)

						slot0[1].ob.piece_nowr_downflag = false
				...
				function slot16()
					if not slot0.piece_nowl_aloneflag and slot1[1].begin_time - slot0.musicgame_nowtime <= slot0.time_good and not slot0.piece_nowl_downflag then
						slot0.piece_nowl_downflag = true

						if slot1[1].begin_time - slot0.musicgame_nowtime <= slot0.time_perfect then
							slot0:score_update(2)
						else
							slot0:score_update(1)
						end
				...
				function slot17()
					if not slot0.piece_nowr_aloneflag and slot1[1].begin_time - slot0.musicgame_nowtime <= slot0.time_good and not slot0.piece_nowr_downflag then
						slot0.piece_nowr_downflag = true
				...
				function slot18()
					if not slot0.piece_nowl_aloneflag and slot0.piece_nowl_downflag then
						slot1[1].ob.localPosition = slot0.pieceinit_xyz.left

						setActive(slot0.pieceinit_xyz.left[1].ob, false)
						setActive:list_push(slot0.piecelist_lf, slot0:list_pop(setActive).ob)

						setActive.list_push.piece_nowl_downflag = false

						setActive.list_push:score_update(0)
						setActive.list_push.score_update:score_update(0)
					end
				...
				function slot19()
					if not slot0.piece_nowr_aloneflag and slot0.piece_nowr_downflag then
						slot1[1].ob.localPosition = slot0.pieceinit_xyz.right

						setActive(slot0.pieceinit_xyz.right[1].ob, false)
						setActive:list_push(slot0.piecelist_rf, slot0:list_pop(setActive).ob)

						setActive.list_push.piece_nowr_downflag = false
				...
				if slot0 == "left" and slot0.piece_nowl.ob and slot0.piece_nowl.begin_time == slot0.piece_nowl.end_time and slot0.downingleft_flag and not slot0.downingleft_lastflag then
					if slot0.piece_nowl.key_flag ~= "K_BOTH" and not slot0.piece_nowl_downflag and not slot0.piece_nowl_aloneflag then
						slot4()
					elseif slot0.piece_nowr.key_flag == "K_BOTH" and slot0.piece_nowr.ob and slot0.downingright_flag and not slot0.piece_nowl_downflag and not slot0.piece_nowl_aloneflag and not slot0.piece_nowr_downflag and not slot0.piece_nowr_aloneflag then
						slot4()
						slot5()
					end
				elseif slot0 == "left" and slot0.piece_nowl.ob and slot0.piece_nowl.begin_time == slot0.piece_nowl.end_time and not slot0.downingleft_flag and slot0.downingleft_lastflag then
					slot0.piece_nowl_aloneflag = false
					slot0.piece_nowl_downflag = false
				elseif slot0 == "left" and slot0.piece_nowl.ob and slot0.piece_nowl.begin_time ~= slot0.piece_nowl.end_time and slot0.downingleft_flag and slot0.downingleft_lastflag and not slot0.piece_nowl_aloneflag and slot0.piece_nowl.key_flag ~= "K_BOTH" then
					if slot0.piece_nowl.key_flag ~= "K_BOTH" and not slot0.piece_nowl_downflag and not slot0.piece_nowl_aloneflag then
						slot8()
					elseif slot0.piece_nowr.key_flag == "K_BOTH" and slot0.piece_nowr.ob and slot0.downingright_flag and not slot0.piece_nowl_downflag and not slot0.piece_nowl_aloneflag and not slot0.piece_nowr_downflag and not slot0.piece_nowr_aloneflag then
						slot8()
				...
				elseif slot0 == "left" and slot0.piece_nowl.ob and slot0.piece_nowl.begin_time ~= slot0.piece_nowl.end_time and not slot0.downingleft_flag and slot0.downingleft_lastflag and slot0.piece_nowl.key_flag ~= "K_BOTH" then
					if slot0.piece_nowl.key_flag ~= "K_BOTH" and slot0.piece_nowl_downflag then
						slot10()
					elseif slot0.piece_nowr.key_flag == "K_BOTH" and slot0.piece_nowr.ob and slot0.piece_nowl_downflag and not slot0.downingright_flag then
						slot10()
						slot11()
					end
				elseif slot0 == "left" and slot0.piece_nowl.ob and slot0.piece_nowl.begin_time ~= slot0.piece_nowl.end_time and (not slot0.downingleft_flag or not slot0.downingleft_lastflag) and slot0.piece_nowl.key_flag ~= "K_BOTH" then
					slot12()
				elseif slot0 == "left" and slot2[0] ~= 0 and slot2[1].ob and slot2[1].begin_time == slot2[1].end_time and slot0.downingleft_flag and not slot0.downingleft_lastflag then
					if slot2[1].key_flag ~= "K_BOTH" and not slot0.piece_nowl_downflag and not slot0.piece_nowl_aloneflag then
						slot6()
					elseif slot0.piecelist_rt[1].key_flag == "K_BOTH" and slot0.piecelist_rt[1].ob and slot0.downingright_flag and not slot0.piece_nowr_downflag and not slot0.piece_nowr_aloneflag and slot0.downingleft_flag and not slot0.piece_nowl_downflag and not slot0.piece_nowl_aloneflag then
						slot6()
						slot7()
					end
				elseif slot0 == "left" and slot2[0] ~= 0 and slot2[1].ob and slot2[1].begin_time == slot2[1].end_time and not slot0.downingleft_flag and slot0.downingleft_lastflag then
					slot0.piece_nowl_aloneflag = false
					slot0.piece_nowl_downflag = false
				elseif slot0 == "left" and slot2[0] ~= 0 and slot2[1].ob and slot2[1].begin_time ~= slot2[1].end_time and slot0.downingleft_flag and not slot0.downingleft_lastflag and slot2[1].key_flag ~= "K_BOTH" then
					if slot2[1].key_flag ~= "K_BOTH" and not slot0.piece_nowl_downflag and not slot0.piece_nowl_aloneflag then
						slot14()
					elseif slot0.piecelist_rt[1].key_flag == "K_BOTH" and slot0.piecelist_rt[1].ob and slot0.downingright_flag and not slot0.piece_nowr_downflag and not slot0.piece_nowr_aloneflag and slot0.downingleft_flag and not slot0.piece_nowl_downflag and not slot0.piece_nowl_aloneflag then
						slot14()
				...
				elseif slot0 == "left" and slot2[0] ~= 0 and slot2[1].ob and slot2[1].begin_time ~= slot2[1].end_time and slot0.downingleft_flag and slot0.downingleft_lastflag and not slot0.piece_nowl_aloneflag and slot2[1].key_flag ~= "K_BOTH" then
					if slot2[1].key_flag ~= "K_BOTH" and not slot0.piece_nowl_downflag and not slot0.piece_nowl_aloneflag then
						slot16()
					elseif slot0.piecelist_rt[1].key_flag == "K_BOTH" and slot0.piecelist_rt[1].ob and slot0.downingright_flag and not slot0.piece_nowr_downflag and not slot0.piece_nowr_aloneflag and slot0.downingleft_flag and not slot0.piece_nowl_downflag and not slot0.piece_nowl_aloneflag then
						slot16()
				...
				elseif slot0 == "left" and slot2[0] ~= 0 and slot2[1].ob and slot2[1].begin_time ~= slot2[1].end_time and not slot0.downingleft_flag and slot0.downingleft_lastflag and slot2[1].key_flag ~= "K_BOTH" then
					if slot2[1].key_flag ~= "K_BOTH" and slot0.piece_nowl_downflag and not slot0.piece_nowl_aloneflag then
						slot18()
					elseif slot0.piecelist_rt[1].key_flag == "K_BOTH" and slot0.piecelist_rt[1].ob and slot0.piece_nowl_downflag and not slot0.piece_nowl_aloneflag and slot0.piece_nowr_downflag and not slot0.piece_nowr_aloneflag then
						slot18()
						slot19()
					end
				elseif not slot0.downingleft_flag and not slot0.downingleft_lastflag then
					slot0.piece_nowl_aloneflag = false
					slot0.piece_nowl_downflag = false
				end

				if slot0 == "right" and slot0.piece_nowr.ob and slot0.piece_nowr.begin_time == slot0.piece_nowr.end_time and slot0.downingright_flag and not slot0.downingright_lastflag then
					if slot0.piece_nowr.key_flag ~= "K_BOTH" and not slot0.piece_nowr_downflag and not slot0.piece_nowr_aloneflag then
						slot5()
					elseif slot0.piece_nowl.key_flag == "K_BOTH" and slot0.piece_nowl.ob and slot0.downingleft_flag and not slot0.piece_nowr_downflag and not slot0.piece_nowr_aloneflag and not slot0.piece_nowl_downflag and not slot0.piece_nowl_aloneflag then
						slot5()
						slot4()
					end
				elseif slot0 == "right" and slot0.piece_nowr.ob and slot0.piece_nowr.begin_time == slot0.piece_nowr.end_time and not slot0.downingright_flag and slot0.downingright_lastflag then
					slot0.piece_nowr_aloneflag = false
					slot0.piece_nowr_downflag = false
				elseif slot0 == "right" and slot0.piece_nowr.ob and slot0.piece_nowr.begin_time ~= slot0.piece_nowr.end_time and slot0.downingright_flag and slot0.downingright_lastflag and not slot0.piece_nowr_aloneflag and slot0.piece_nowr.key_flag ~= "K_BOTH" then
					if slot0.piece_nowr.key_flag ~= "K_BOTH" and not slot0.piece_nowr_downflag and not slot0.piece_nowr_aloneflag then
						slot9()
					elseif slot0.piece_nowl.key_flag == "K_BOTH" and slot0.piece_nowl.ob and slot0.downingleft_flag and not slot0.piece_nowr_downflag and not slot0.piece_nowr_aloneflag and not slot0.piece_nowl_downflag and not slot0.piece_nowl_aloneflag then
						slot9()
				...
				elseif slot0 == "right" and slot0.piece_nowr.ob and slot0.piece_nowr.begin_time ~= slot0.piece_nowr.end_time and not slot0.downingright_flag and slot0.downingright_lastflag and slot0.piece_nowr.key_flag ~= "K_BOTH" then
					if slot0.piece_nowr.key_flag ~= "K_BOTH" and slot0.piece_nowr_downflag then
						slot11()
					elseif slot0.piece_nowl.key_flag == "K_BOTH" and slot0.piece_nowl.ob and slot0.piece_nowr_downflag and not slot0.downingleft_flag then
						slot11()
						slot10()
					end
				elseif slot0 == "right" and slot0.piece_nowr.ob and slot0.piece_nowr.begin_time ~= slot0.piece_nowr.end_time and (not slot0.downingright_flag or not slot0.downingright_lastflag) and slot0.piece_nowr.key_flag ~= "K_BOTH" then
					slot13()
				elseif slot0 == "right" and slot2[0] ~= 0 and slot2[1].ob and slot2[1].begin_time == slot2[1].end_time and slot0.downingright_flag and not slot0.downingright_lastflag then
					if slot2[1].key_flag ~= "K_BOTH" and not slot0.piece_nowr_downflag and not slot0.piece_nowr_aloneflag then
						slot7()
					elseif slot0.piecelist_lt[1].key_flag == "K_BOTH" and slot0.piecelist_lt[1].ob and slot0.downingright_flag and not slot0.piece_nowr_downflag and not slot0.piece_nowr_aloneflag and slot0.downingleft_flag and not slot0.piece_nowl_downflag and not slot0.piece_nowl_aloneflag then
						slot7()
						slot6()
					end
				elseif slot0 == "right" and slot2[0] ~= 0 and slot2[1].ob and slot2[1].begin_time == slot2[1].end_time and slot0.downingright_flag and not slot0.downingright_lastflag then
					slot0.piece_nowr_aloneflag = false
					slot0.piece_nowr_downflag = false
				elseif slot0 == "right" and slot2[0] ~= 0 and slot2[1].ob and slot2[1].begin_time ~= slot2[1].end_time and slot0.downingright_flag and not slot0.downingright_lastflag and slot2[1].key_flag ~= "K_BOTH" then
					if slot2[1].key_flag ~= "K_BOTH" and not slot0.piece_nowr_downflag and not slot0.piece_nowr_aloneflag then
						slot15()
					elseif slot0.piecelist_lt[1].key_flag == "K_BOTH" and slot0.piecelist_lt[1].ob and slot0.downingright_flag and not slot0.piece_nowr_downflag and not slot0.piece_nowr_aloneflag and slot0.downingleft_flag and not slot0.piece_nowl_downflag and not slot0.piece_nowl_aloneflag then
						slot15()
				...
				elseif slot0 == "right" and slot2[0] ~= 0 and slot2[1].ob and slot2[1].begin_time ~= slot2[1].end_time and slot0.downingright_flag and slot0.downingright_lastflag and not slot0.piece_nowr_aloneflag and slot2[1].key_flag ~= "K_BOTH" then
					if slot2[1].key_flag ~= "K_BOTH" and not slot0.piece_nowr_downflag and not slot0.piece_nowr_aloneflag then
						slot17()
					elseif slot0.piecelist_lt[1].key_flag == "K_BOTH" and slot0.piecelist_lt[1].ob and slot0.downingright_flag and not slot0.piece_nowr_downflag and not slot0.piece_nowr_aloneflag and slot0.downingleft_flag and not slot0.piece_nowl_downflag and not slot0.piece_nowl_aloneflag then
						slot17()
				...
				elseif slot0 == "right" and slot2[0] ~= 0 and slot2[1].ob and slot2[1].begin_time ~= slot2[1].end_time and not slot0.downingright_flag and slot0.downingright_lastflag and slot2[1].key_flag ~= "K_BOTH" then
					if slot2[1].key_flag ~= "K_BOTH" and slot0.piece_nowr_downflag and not slot0.piece_nowr_aloneflag then
						slot19()
					elseif slot0.piecelist_lt[1].key_flag == "K_BOTH" and slot0.piecelist_lt[1].ob and slot0.piece_nowr_downflag and not slot0.piece_nowr_aloneflag and slot0.piece_nowl_downflag and not slot0.piece_nowl_aloneflag then
						slot19()
						slot18()
					end
				elseif not slot0.downingright_flag and not slot0.downingright_lastflag then
					slot0.piece_nowr_aloneflag = false
					slot0.piece_nowr_downflag = false
				end
			end
			...
			for slot8 = 1, slot2[0], 1 do
				slot10 = slot0:list_pop(slot2).ob.localPosition
				slot11 = (slot0.musicgame_nowtime - slot0.list_pop(slot2).begin_time + slot1) * slot1

				if slot0 == "left" then
					slot9.ob.localPosition = Vector3(slot0.pieceinit_xyz[slot0].x + slot11, slot10.y, slot10.z)

					if slot9.ob.localPosition.x < 0 then
						slot0:list_push(slot2, slot9)
					else
						slot9.ob.localPosition = Vector3(0, slot10.y, slot10.z)

						if slot0.piece_nowl.ob then
							slot0.piece_nowl.ob.localPosition = Vector3(slot0.pieceinit_xyz.left.x, slot10.y, slot10.z)

							setActive(slot0.piece_nowl.ob, false)
							slot0:list_push(slot3, slot0.piece_nowl.ob)
						end

						slot0.piece_nowl.ob = slot9.ob
						slot0.piece_nowl.begin_time = slot9.begin_time
						slot0.piece_nowl.end_time = slot9.end_time
						slot0.piece_nowl.key_flag = slot9.key_flag

						slot0.piece_nowl.ob:GetComponent(typeof(Transform)):SetAsFirstSibling()
					end
				elseif slot0 == "right" then
					slot9.ob.localPosition = Vector3(slot0.pieceinit_xyz[slot0].x - slot11, slot10.y, slot10.z)
					...
					if slot9.ob.localPosition.x > 0 then
						...
						if slot0.piece_nowr.ob then
							slot0.piece_nowr.ob.localPosition = Vector3(slot0.pieceinit_xyz.right.x, slot10.y, slot10.z)

							setActive(slot0.piece_nowr.ob, false)
							slot0:list_push(slot3, slot0.piece_nowr.ob)
						end

						slot0.piece_nowr.ob = slot9.ob
						slot0.piece_nowr.begin_time = slot9.begin_time
						slot0.piece_nowr.end_time = slot9.end_time
						slot0.piece_nowr.key_flag = slot9.key_flag

						slot0.piece_nowr.ob:GetComponent(typeof(Transform)):SetAsFirstSibling()
					end
				end
			end

			if slot0 == "left" and slot0.piece_nowl.ob and slot0.piece_nowl.begin_time == slot0.piece_nowl.end_time then
				if slot0.piece_nowl.key_flag == "K_BOTH" then
					slot0.piece_nowl.ob:Find(slot0.game_dgree .. "/note_2"):GetComponent(typeof(Image)).color = Color.New(1, 1, 1, slot0.piece_nowl.ob:Find(slot0.game_dgree .. "/note_2"):GetComponent(typeof(Image)).color.a - (slot0.musicgame_nowtime - slot0.musicgame_lasttime) / slot0.time_latergood)

					if slot0.piece_nowl.ob:Find(slot0.game_dgree .. "/note_2"):GetComponent(typeof(Image)).color.a <= 0 then
						slot0.piece_nowl.ob.localPosition = slot0.pieceinit_xyz.left
					...
					slot0.piece_nowl.ob:Find(slot0.game_dgree .. "/note_1"):GetComponent(typeof(Image)).color = Color.New(1, 1, 1, slot0.piece_nowl.ob:Find(slot0.game_dgree .. "/note_1"):GetComponent(typeof(Image)).color.a - (slot0.musicgame_nowtime - slot0.musicgame_lasttime) / slot0.time_latergood)

					if slot0.piece_nowl.ob:Find(slot0.game_dgree .. "/note_1"):GetComponent(typeof(Image)).color.a <= 0 then
						slot0.piece_nowl.ob.localPosition = slot0.pieceinit_xyz.left
			...
			if slot0 == "right" and slot0.piece_nowr.ob and slot0.piece_nowr.begin_time == slot0.piece_nowr.end_time then
				if slot0.piece_nowl.key_flag == "K_BOTH" then
					slot0.piece_nowr.ob:Find(slot0.game_dgree .. "/note_2"):GetComponent(typeof(Image)).color = Color.New(1, 1, 1, slot0.piece_nowr.ob:Find(slot0.game_dgree .. "/note_2"):GetComponent(typeof(Image)).color.a - (slot0.musicgame_nowtime - slot0.musicgame_lasttime) / slot0.time_latergood)

					if slot0.piece_nowr.ob:Find(slot0.game_dgree .. "/note_2"):GetComponent(typeof(Image)).color.a <= 0 then
						slot0.piece_nowr.ob.localPosition = slot0.pieceinit_xyz.right
					...
					slot0.piece_nowr.ob:Find(slot0.game_dgree .. "/note_1"):GetComponent(typeof(Image)).color = Color.New(1, 1, 1, slot0.piece_nowr.ob:Find(slot0.game_dgree .. "/note_1"):GetComponent(typeof(Image)).color.a - (slot0.musicgame_nowtime - slot0.musicgame_lasttime) / slot0.time_latergood)

					if slot0.piece_nowr.ob:Find(slot0.game_dgree .. "/note_1"):GetComponent(typeof(Image)).color.a <= 0 then
						slot0.piece_nowr.ob.localPosition = slot0.pieceinit_xyz.right
			...
			if slot0 == "left" and slot0.piece_nowl.ob and slot0.piece_nowl.begin_time ~= slot0.piece_nowl.end_time then
				if slot0.piece_nowl.key_flag == "K_BOTH" then
					slot0.piece_nowl.ob:Find(slot0.game_dgree .. "/notelong_2/note_above/below"):GetComponent(typeof(Image)).color = Color.New(1, 1, 1, (slot0.piece_nowl_downflag and 1) or 0.4)
					slot0.piece_nowl.ob:Find(slot0.game_dgree .. "/notelong_2/note_above/above"):GetComponent(typeof(Image)).color = Color.New(1, 1, 1, (slot0.piece_nowl_downflag and 1) or 0.8)
					slot0.piece_nowl.ob:Find(slot0.game_dgree .. "/notelong_2/note_above"):GetComponent(typeof(RectTransform)).offsetMin = Vector2((274 - 1142 / slot2 * (slot0.piece_nowl.end_time - slot0.musicgame_nowtime) < 274 and Color.New) or 274, slot0.piece_nowl.ob:Find(slot0.game_dgree .. "/notelong_2/note_above"):GetComponent(typeof(RectTransform)).offsetMin.y)

					if slot0.time_latergood < slot0.musicgame_nowtime - slot0.piece_nowl.end_time then
						slot0.piece_nowl.ob.localPosition = slot0.pieceinit_xyz.left
					...
					slot0.piece_nowl.ob:Find(slot0.game_dgree .. "/notelong_1/note_above/below"):GetComponent(typeof(Image)).color = Color.New(1, 1, 1, (slot0.piece_nowl_downflag and 1) or 0.4)
					slot0.piece_nowl.ob:Find(slot0.game_dgree .. "/notelong_1/note_above/above"):GetComponent(typeof(Image)).color = Color.New(1, 1, 1, (slot0.piece_nowl_downflag and 1) or 0.8)
					slot0.piece_nowl.ob:Find(slot0.game_dgree .. "/notelong_1/note_above"):GetComponent(typeof(RectTransform)).offsetMin = Vector2((274 - 1142 / slot2 * (slot0.piece_nowl.end_time - slot0.musicgame_nowtime) < 274 and Color.New) or 274, slot0.piece_nowl.ob:Find(slot0.game_dgree .. "/notelong_1/note_above"):GetComponent(typeof(RectTransform)).offsetMin.y)
			...
			if slot0 == "right" and slot0.piece_nowr.ob and slot0.piece_nowr.begin_time ~= slot0.piece_nowr.end_time then
				if slot0.piece_nowl.key_flag == "K_BOTH" then
					slot0.piece_nowr.ob:Find(slot0.game_dgree .. "/notelong_2/note_above/below"):GetComponent(typeof(Image)).color = Color.New(1, 1, 1, (slot0.piece_nowr_downflag and 1) or 0.4)
					slot0.piece_nowr.ob:Find(slot0.game_dgree .. "/notelong_2/note_above/above"):GetComponent(typeof(Image)).color = Color.New(1, 1, 1, (slot0.piece_nowr_downflag and 1) or 0.8)
					slot0.piece_nowr.ob:Find(slot0.game_dgree .. "/notelong_2/note_above"):GetComponent(typeof(RectTransform)).offsetMax = Vector2(-((274 - 1142 / slot2 * (slot0.piece_nowr.end_time - slot0.musicgame_nowtime) < 274 and Color.New) or 274), slot0.piece_nowr.ob:Find(slot0.game_dgree .. "/notelong_2/note_above"):GetComponent(typeof(RectTransform)).offsetMax.y)

					if slot0.time_latergood < slot0.musicgame_nowtime - slot0.piece_nowr.end_time then
						slot0.piece_nowr.ob.localPosition = slot0.pieceinit_xyz.right
					...
					slot0.piece_nowr.ob:Find(slot0.game_dgree .. "/notelong_1/note_above/below"):GetComponent(typeof(Image)).color = Color.New(1, 1, 1, (slot0.piece_nowr_downflag and 1) or 0.4)
					slot0.piece_nowr.ob:Find(slot0.game_dgree .. "/notelong_1/note_above/above"):GetComponent(typeof(Image)).color = Color.New(1, 1, 1, (slot0.piece_nowr_downflag and 1) or 0.8)
					slot0.piece_nowr.ob:Find(slot0.game_dgree .. "/notelong_1/note_above"):GetComponent(typeof(RectTransform)).offsetMax = Vector2(-((274 - 1142 / slot2 * (slot0.piece_nowr.end_time - slot0.musicgame_nowtime) < 274 and Color.New) or 274), slot0.piece_nowr.ob:Find(slot0.game_dgree .. "/notelong_1/note_above"):GetComponent(typeof(RectTransform)).offsetMax.y)
