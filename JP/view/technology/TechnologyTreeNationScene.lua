...
function slot0.updateTecItemList(slot0)
	...
	slot1:make(function (slot0, slot1, slot2)
		if slot0 == UIItemList.EventUpdate then
			uv0.panelList[slot1 + 1] = slot2

			uv0:updateTecItem(slot1 + 1)
		end
	end)
...
function slot0.updateTecItem(slot0, slot1)
	...
	onToggle(slot0, slot0:findTF("BG", slot3), function (slot0)
		if slot0 then
			...
			LeanTween.value(go(uv1), slot1, uv2.tecItemTplOriginWidth, 0.25):setOnUpdate(System.Action_float(function (slot0)
...
function slot0.updateDetailPanel(slot0, slot1, slot2, slot3, slot4, slot5)
	...
	function slot9(slot0, slot1, slot2)
		...
		for slot15, slot16 in ipairs(slot9) do
			...
			-- Decompilation error in this vicinity:
			--- BLOCK #0 49-126, warpins: 1 ---
			for slot23, slot24 in ipairs(slot19) do

				-- Decompilation error in this vicinity:
				--- BLOCK #0 56-124, warpins: 1 ---
				slot25 = nil
		...
		slot3:make(function (slot0, slot1, slot2)
			...
			if slot0 == UIItemList.EventUpdate then
				...
				setImageSprite(slot3, GetSpriteFromAtlas("ShipType", "buffitem_tec_" .. uv1[slot1 + 1]))
				uv0:upBuffList(slot2, uv2[uv1[slot1 + 1]])
				--- END OF BLOCK #0 ---
...
function slot0.upBuffList(slot0, slot1, slot2)
	...
	slot4:make(function (slot0, slot1, slot2)
		...
		if slot0 == UIItemList.EventUpdate then
			...
			-- Decompilation error in this vicinity:
			--- BLOCK #0 5-62, warpins: 1 ---
			slot8 = uv1[slot1 + 1].valueColor

			setText(slot3, AttributeType.Type2Name(pg.attribute_info_by_type[uv1[slot1 + 1].attr].name))
