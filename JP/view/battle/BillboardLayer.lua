...
function slot0.setRank(slot0, slot1, slot2, slot3, slot4, slot5)
	...
	if (slot3 or 1) < 5 and slot0.rankList[slot6][slot3] and #slot0.rankList[slot6][slot3] >= 20 then
...
function slot0.init(slot0)
	...
	for slot6, slot7 in ipairs(slot2) do
		...
		slot0.scroll[slot7].onUpdateItem = function (slot0, slot1)
			...
			uv0.rankList[uv1][math.floor(slot0 / 20) + 1][slot0 % 20 + 1].medal_small = uv0:getRankMsgInfo(uv1).medal_small
			slot3.max = uv0.getRankMsgInfo(uv1).type == 2 and uv0.collectCountAll or nil
