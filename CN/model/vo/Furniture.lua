...
function slot0.getPrice(slot0, slot1)
	...
	if slot1 == 4 and slot0:getConfig("gem_price") or slot1 == 6 and slot0:getConfig("dorm_icon_price") then
		return slot4 > 0 and math.floor(slot4 * (100 - (slot0.isDisCount() and slot0.getConfig("discount") or 0)) / 100) == 0 and 1 or math.floor(slot4 * (100 - (slot0.isDisCount() and slot0.getConfig("discount") or 0)) / 100)
	end
end
