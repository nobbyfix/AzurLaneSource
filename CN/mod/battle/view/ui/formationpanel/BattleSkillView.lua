...
function ys.Battle.BattleSkillView.SubmarineButton(slot0)
	...
	slot0._torpedoBtn:GetSkin().transform.anchorMin = Vector2(uv0.SKILL_BUTTON_DEFAULT_PREFERENCE[2].x, uv0.SKILL_BUTTON_DEFAULT_PREFERENCE[2].y)
	slot0._torpedoBtn.GetSkin().transform.anchorMax = Vector2(uv0.SKILL_BUTTON_DEFAULT_PREFERENCE[2].x, uv0.SKILL_BUTTON_DEFAULT_PREFERENCE[2].y)
end
...
function ys.Battle.BattleSkillView.setSkillButtonPreferences(slot0, slot1, slot2)
	...
	slot1.transform.anchorMax = Vector2(PlayerPrefs.GetFloat("skill_" .. slot2 .. "_anchorX", uv0.SKILL_BUTTON_DEFAULT_PREFERENCE[slot2].x), PlayerPrefs.GetFloat("skill_" .. slot2 .. "_anchorY", uv0.SKILL_BUTTON_DEFAULT_PREFERENCE[slot2].y))
end
