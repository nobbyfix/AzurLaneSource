...
function slot2.Charge(slot0)
	...
	slot0:DispatchEvent(uv0.Event.New(uv0.Battle.BattleUnitEvent.CHARGE_WEAPON_CHARGE, slot1))
end
...
function slot2.CancelCharge(slot0)
	...
	slot0:DispatchEvent(uv0.Event.New(uv0.Battle.BattleUnitEvent.CHARGE_WEAPON_CANCEL, slot1))
end
