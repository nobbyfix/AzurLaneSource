...
function slot4.DispatchBlink(slot0, slot1)
	slot0:DispatchEvent(uv0.Event.New(uv1.CHARGE_WEAPON_FINISH, slot2))
end
...
function slot4.Charge(slot0)
	...
	slot0:DispatchEvent(uv0.Event.New(uv1.POINT_HIT_CHARGE, slot1))
...
function slot4.CancelCharge(slot0)
	...
	slot0:DispatchEvent(uv0.Event.New(uv1.POINT_HIT_CANCEL, slot1))
