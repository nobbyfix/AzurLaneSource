...
function slot9(slot0)
	...
	if slot1.GetCLDCenterPosition() - slot0.GetPosition().x * slot1.GetCLDCenterPosition() - slot0.GetPosition().z > 0 then
		slot5 = math.cos(slot0._negativeCosAngularSpeed * slot0:GetSpeedRatio())
		slot6 = math.sin(slot0._negativeSinAngularSpeed * slot0.GetSpeedRatio())
	else
...
function ys.Battle.BattleBulletUnit.calcSpeed(slot0)
	slot0._speed = Vector3(uv1.ConvertBulletSpeed(slot0._velocity * (1 + uv0.Battle.BattleAttr.GetCurrent(slot0, "bulletSpeedRatio"))) * math.cos(slot3), 0, uv1.ConvertBulletSpeed(slot0._velocity * (1 + uv0.Battle.BattleAttr.GetCurrent(slot0, "bulletSpeedRatio"))) * math.sin(math.deg2Rad * slot0._yAngle))
end
