...
function pg.TrophyReminderMgr.ShowTips(slot0, slot1)
	...
	LoadImageSpriteAsync("medal/s_" .. uv0.medal_template[slot1].icon, slot2.transform:Find("content/icon"), true)
	setText(slot2.transform:Find("content/name"), uv0.medal_template[slot1].name)
