...
function slot51(slot0)
	...
	if uv0(slot0, 4194304) == 0 then
		...
		if slot2 ~= 0 then
			slot4 = uv7(uv3(slot4, slot2), slot2 == 32 and 0 or uv0(uv7(uv3(slot3, slot2), uv3(slot4, slot2)), uv2(-1, 32 - slot2)))
			slot3 = uv7(uv3(slot3, slot2), slot2 == 32 and 0 or uv0(uv7(uv3(slot3, slot2), uv3(slot4, slot2)), uv2(-1, 32 - slot2)))
...
function slot55(slot0)
	slot10, slot10, slot9, slot8 = uv0(slot0.code, slot0.pos + 1, slot0.pos + 4)
	slot7 = {}
	slot8 = ""
	slot9, slot10, slot11, slot12 = nil
	slot0.op = uv1(uv2(slot5, 24), uv2(slot4, 16), uv2(slot3, 8), slot2)
	slot0.rel = nil
	slot9 = nil
	slot13 = nil
	...
	slot14, slot15 = uv8(slot11, "|([a-z0-9_.|]*)(.*)")
	...
	for slot22 in uv11(slot11, ".") do
		...
		if slot22 == "D" then
			slot23 = slot16 and slot12[uv4(slot6, 31)] or uv12(slot22, slot11, uv4(slot6, 31))
		elseif slot22 == "N" then
			slot23 = slot16 and slot12[uv4(uv5(slot6, 5), 31)] or uv12(slot22, slot11, uv4(uv5(slot6, 5), 31))
		elseif slot22 == "M" then
			slot23 = slot16 and slot12[uv4(uv5(slot6, 16), 31)] or uv12(slot22, slot11, uv4(uv5(slot6, 16), 31))
		elseif slot22 == "A" then
			slot23 = slot16 and slot12[uv4(uv5(slot6, 10), 31)] or uv12(slot22, slot11, uv4(uv5(slot6, 10), 31))
		elseif slot22 == "B" then
			slot0.rel = slot0.addr + slot1 + uv13(slot6, slot10)
			slot23 = "0x" .. uv14(slot0.addr + slot1 + uv13(slot6, slot10))
