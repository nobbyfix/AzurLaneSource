...
function slot0.openDescPanel(slot0, slot1, slot2)
	...
	LeanTween.moveX(slot0.samllTF, 800, slot3):setFrom(0):setOnComplete(System.Action(function ()
		...
		LeanTween.moveX(uv0.descFrameTF, 0, uv1):setFrom(800):setOnComplete(System.Action(uv2))
	end))
...
function slot0.closeDescPanel(slot0, slot1)
	...
	LeanTween.moveX(slot0.descFrameTF, 800, slot2):setFrom(0):setOnComplete(System.Action(function ()
		...
		LeanTween.moveX(uv0.samllTF, 0, uv1):setFrom(800)
	end))
...
function slot0.updateDesc(slot0)
	for slot5 = 1, CommanderConst.MAX_FORMATION_POS, 1 do
		...
		slot0:updateSkillTF(slot0.fleet:getCommanders()[slot5], slot0["skillTFPos" .. slot5])
	end
...
function slot0.updateAdditions(slot0)
	...
	slot0.abilitysTF:make(function (slot0, slot1, slot2)
		if slot0 == UIItemList.EventUpdate then
			setText(slot2:Find("name"), AttributeType.Type2Name(uv0[slot1 + 1].attrName))
			setText(slot2:Find("Text"), "+" .. math.floor(uv0[slot1 + 1].value * 1000) / 1000 .. "%")
			GetImageSpriteFromAtlasAsync("attricon", uv0[slot1 + 1].attrName, slot2:Find("icon"), false)
...
function slot0.updateSkillTF(slot0, slot1, slot2)
	...
	if slot1 then
		...
		onButton(slot0, slot2, function ()
			uv0.parent:emit(FormationMediator.ON_CMD_SKILL, uv1)
		end, SFX_PANEL)
...
function slot0.updateCommander(slot0, slot1, slot2, slot3, slot4)
	...
	if slot4 then
		onButton(slot0, slot6, function ()
			uv0.parent:emit(FormationMediator.ON_SELECT_COMMANDER, uv1, uv0.fleet.id)
		end, SFX_PANEL)
