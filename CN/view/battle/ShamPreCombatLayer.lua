...
function slot0.didEnter(slot0)
	...
	onButton(slot0, slot0._strategy, function ()
		uv0:displayStrategyInfo(_.detect(slot0, function (slot0)
...
function slot0.EnableAddGrid(slot0, slot1)
	if #slot0.chapter.fleet[slot1] < 3 then
		slot8 = slot0._gridTFs[slot1][slot6 + 1].Find(slot7, "tip")
...
function slot0.displayFleetInfo(slot0)
	...
	uv0.tweenNumText(slot0._mainGS, _.reduce(slot0.chapter.fleet.getShipsByTeam(slot1, TeamType.Main, false), 0, function (slot0, slot1)
