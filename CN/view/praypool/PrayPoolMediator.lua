...
function slot0.register(slot0)
	...
	if getProxy(PrayProxy).getPageState(slot2) ~= PrayProxy.STAGE_BUILD_SUCCESS and getProxy(ActivityProxy):getActivityById(ActivityConst.ACTIVITY_PRAY_POOL) then
