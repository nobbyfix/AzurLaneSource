...
function slot0.load(slot0, slot1, slot2)
	...
	if #slot0.pics > 0 then
		slot0.puzzlaWidth = slot0.pics[1].rect.width * uv0
		slot0.puzzlaHeight = slot0.pics[1].rect.height * uv1
...
function slot0.disorganizePuzzla(slot0, slot1)
	...
	if slot1 and #slot1 > 0 then
		...
		for slot6 = 1, uv1, 1 do
			...
			slot0.prevDir = uv2[slot0.disorganizeStep()]
		end
