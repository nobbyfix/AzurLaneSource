...
slot0.SORT_FURNITURE_FUNC = function (slot0, slot1, slot2, slot3)
	slot3 = slot3 or 1
...
slot0.updateFurnitureOrder = function (slot0, slot1)
...
slot0.initTheme = function (slot0)
	...
	slot0.themVewRect.onInitItem = function (slot0)
		slot0:initThemeItem(slot0)
	end

	slot0.themVewRect.onUpdateItem = function (slot0, slot1)
...
slot0.createThemeItem = function (slot0, slot1)
	slot3 = findTF(({
		tr = tf(slot1),
		_go = slot1,
...
slot0.initThemeItem = function (slot0, slot1)
...
slot0.sortThemes = function (slot0)
	slot1 = {}
...
slot0.updateThemeItem = function (slot0, slot1, slot2)
...
slot0.openItemDesc = function (slot0, slot1)
...
slot0.updateThemeDesc = function (slot0, slot1)
...
slot0.updateSubThemeList = function (slot0, slot1)
	slot0.descItemVOs = {}
	...
	slot0.descRect.onInitItem = function (slot0)
		slot0:onInitThemeDesc(slot0)
	end

	slot0.descRect.onUpdateItem = function (slot0, slot1)
...
slot0.getDescItem = function (slot0, slot1)
...
slot0.onInitThemeDesc = function (slot0, slot1)
...
slot0.purchase = function (slot0, slot1, slot2, slot3)
	slot4 = {}
...
slot0.sortSubTheme = function (slot0)
...
slot0.closeItemDesc = function (slot0)
...
slot0.getActiveFurnitureById = function (slot0, slot1)
	slot2 = nil
	slot3 = false
...
slot0.setAllFurnitrues = function (slot0, slot1)
	slot0.furnitures = {}
...
slot0.initSubFurnitureType = function (slot0)
...
slot0.getCardItem = function (slot0, slot1)
...
slot0.onInitFurnitrue = function (slot0, slot1)
...
slot0.showMsgBox = function (slot0, slot1, slot2, slot3)
...
slot0.calcFurnituresPrice = function (slot0)
	slot1 = 0
	slot2 = 0
...
slot0.updateThemes = function (slot0)
	slot0:sortThemes()
end
...
slot0.openIndexPanel = function (slot0)
	...
	slot0.indexPanel.onHideFunc = function ()
		setParent(slot0.filterTF, slot0._tf)
	end
end
