...
11. 시즌 종료 후, 모든 유저의 등급과 점수는 리셋됩니다.]],
	...
	exercise_award_tip = {
		tip = "시즌 기간 중, 등급이 상승하면, 각 등급마다 한 번씩 보상이 지급됩니다.：",
 ...
 ‘숙련도’가 2배가 됩니다.]]
	...
	card_pairs_help_tip = {
		...
		tip = {
			...
			{
				info = " 6. [기억 카드] 를 10장 입수하면 호쇼 스킨 [초저녁의 꿈]을 획득 가능."
			},
			{
...
있도록 하여 주십시오.]]
	...
	goldship_help_tip = {
		...
		tip = {
			...
			{
				info = "5. [역전의 증표]를 7개 얻으면, 워스파이트의 근대화 개수\n소재 아이템 [전사의 마음가짐]을 획득할 수 있습니다. ；"
			},
			{
				info = "6. 미니 게임에서 퇴각하면 [역전의 증표]와 [주사위]를\n획득할 수 없습니다.；"
			},
			{
				info = "7. 남은 시간이 0이 되면, 미니 게임이 종료됩니다.；"
			}
		}
	},
...
초대 받은 자：
2019년 4월 20일에서 5월 20일 업데이트 기간에 로그인하지 
않고 지휘관 레벨이 15와 같거나 큰 지휘관들은
 스페셜 이벤트에 초대 받을 자격이 됩니다.
초대는 스페셜 이벤트 화면 내 초대자의 UID를 기입하면 
이벤트를 참여할 수 있습니다. 
초대자: 
2019년 4월 20일에서 5월 20일 업데이트 전까지 
로그인했거나 이벤트 중 지휘관 레벨이 15 미만이였지만 
15를 도달한 지휘관들 및 이벤트 후 가입하여 지휘관 레벨 
15를 도달한 지휘관들도 자신의 UID 를 사용해 상대방을 
초대할 수 있습니다.
지휘관 소환:
초대자는 최대 3명의 지휘관을 초대할 수 있으며, 이벤트 
전용 임무 완료 시 집결 포인트를 획득할 수 있습니다. 
집결 포인트가 특정 수치를 도달하면 풍부한 보상을
획득할 수 있습니다.
초대 받은 자가 초대자의 UID를 기입하는 즉시 이벤트 
전용 임무를 활성화합니다. 전용 임무를 완료하면 풍부한 
보상을 획득하고 초대자에게 집결 포인트를 제공합니다.
초대는 타 항구에서도 진행할 수 있지만, 타 서버에서는
 불가능합니다.
UID: 사령부에서 각 지휘관에게 전달한 고유의 신분 증명 
숫자이며,개인 정보 화면에서 확인할 수 있습니다.]]
			},
			{
				info = "UID발령 및 매칭 시스템：\n"
			},
			{
				info = [[
발령자：
【동원 신호 발령】버튼을 클릭하여 자신의 UID정보를 
발령할 수 있습니다，복귀한 지휘관에게 빠른 매칭을
 제공합니다
<color=#ff5c5c>동원 신호 발령 후 취소할 수 없습니다</color>]]
			},
			{
				info = [[
복귀 지휘관：
【매치 및 연동】버튼을 클릭하여 랜덤으로 한 명의 발령자
의 UID정보와 고속 연동 가능합니다. 
<color=#ff5c5c>연동 성공 후 변경할 수 없습니다.</color>]]
			}
		}
	},
	attire_time_stamp = {
	...
	returner_max_count = {
		tip = "발령 횟수가 이미 최대치에 도달하였습니다",
		key = "returner_max_count"
	},
	returner_push_tip = {
		tip = "\"해당 조작은 지휘관 님의 UID를 시스템에 발령하게 되며, 복귀 지휘관과 매치하게 됩니다. 발령 후, <color=#FF5C5C>취소할 수 없습니다</color>\n발령하시겠습니까?\"",
