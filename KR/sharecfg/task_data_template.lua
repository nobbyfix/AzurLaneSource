...
pg.task_data_template = {
	...
	[1061] = {
		...
		name = "데일리 챌린지",
		count_inherit = 0,
		desc = "함대를 출격시켜, 데일리 챌린지를 1번 수행하라!",
		target_id_2 = "",
		sub_type = 26,
		added_tip = 0,
		story_icon = "",
	...
	[2201] = {
		...
		name = "병참 강화",
		count_inherit = 0,
		desc = "일간 임무 「식량 보급」을 5번 완수하여 병참을 \n충실히 하라!",
		target_id_2 = "",
		sub_type = 91,
		added_tip = 0,
		story_icon = "",
	...
	[5041] = {
		...
		award = 5041,
		type = 2,
		name = "인식 각성 (1레벨)을 진행한다.",
		count_inherit = 0,
		desc = "임의의 함선소녀 레벨 상한을 105로 \n올려준다.",
		target_id_2 = "",
		sub_type = 36,
		added_tip = 0,
		story_icon = "",
	...
	[5042] = {
		...
		award = 5042,
		type = 2,
		name = "인식 각성 (2레벨)을 진행한다.",
		count_inherit = 0,
		desc = "임의의 함선소녀 레벨 상한을 110로 \n올려준다.",
		target_id_2 = "",
		sub_type = 36,
		added_tip = 0,
		story_icon = "",
	...
	[5043] = {
		...
		award = 5043,
		type = 2,
		name = "인식 각성 (3레벨)을 진행한다.",
		count_inherit = 0,
		desc = "임의의 함선소녀 레벨 상한을 115로 \n올려준다.",
		target_id_2 = "",
		sub_type = 36,
		added_tip = 0,
		story_icon = "",
	...
	[5044] = {
		...
		award = 5044,
		type = 2,
		name = "인식 각성 (4레벨)을 진행한다.",
		count_inherit = 0,
		desc = "임의의 함선소녀 레벨 상한을 120로 \n올려준다.",
		target_id_2 = "",
		sub_type = 36,
		added_tip = 0,
		story_icon = "",
	...
	[5194] = {
		...
		name = "쉬르쿠프의 점심",
		count_inherit = 0,
		desc = "쉬르쿠프를 포함한 함대로 구조 신호 스테이지를\n1회 클리어 한다.",
		target_id_2 = "",
		sub_type = 21,
		added_tip = 1,
		story_icon = "xukufu",
	...
	[5244] = {
		...
		name = "악마와의 계약",
		count_inherit = 0,
		desc = "알바코어를 포함한 함대로 구조 신호 스테이지를\n1회 클리어 한다.",
		target_id_2 = "",
		sub_type = 21,
		added_tip = 1,
		story_icon = "daqinghuayu",
	...
	[5313] = {
		...
		award = 5235,
		type = 5,
		name = "기습 취재! 이웃의 보급 상점!",
		count_inherit = 0,
		desc = "시라누이를 포함한 함대를 출격시켜\n20회 승리한다.",
		target_id_2 = "",
		sub_type = 18,
		added_tip = 1,
		story_icon = "buzhihuo",
	...
	[5332] = {
		...
		award = 5248,
		type = 5,
		name = "특훈! 전력을 다하는 건 사쿠라 엠파이어의 미덕",
		count_inherit = 0,
		desc = "임의의 함선소녀를 10회 강화한다.",
		target_id_2 = "",
		sub_type = 34,
	...
	[5333] = {
		...
		award = 5249,
		type = 5,
		name = "전념! 그러나 그녀의 걸음은 멈추지 않으니",
		count_inherit = 0,
		desc = "류조를 포함한 함대를 출격시켜\n 20회 승리한다.",
		target_id_2 = "",
		sub_type = 18,
		added_tip = 1,
		story_icon = "longxiang",
	...
	[5334] = {
		...
		award = 5250,
		type = 5,
		name = "위험! 소녀를 유혹하는 수수께끼의 미각",
		count_inherit = 0,
		desc = "류조를 포함한 함대로 데일리 챌린지를 \n3회 클리어한다.",
		target_id_2 = "",
		sub_type = 19,
		added_tip = 1,
		story_icon = "longxiang",
	...
	[5337] = {
		...
		award = 5253,
		type = 5,
		name = "용기! 역시 지휘관이 제일 좋아",
		count_inherit = 0,
		desc = "류조의 레벨을 100까지 달성한다.",
		target_id_2 = "",
		sub_type = 1013,
		added_tip = 1,
		story_icon = "longxiang",
	...
	[5454] = {
		...
		name = "기사장의 지휘",
		count_inherit = 0,
		desc = "킹 조지 5세를 포함한 함대로 데일리 챌린지를\n3회 클리어한다.",
		target_id_2 = "",
		sub_type = 19,
		added_tip = 1,
		story_icon = "qiaozhiwushi",
	...
	[5464] = {
		...
		name = "예약했어?",
		count_inherit = 0,
		desc = "U-556를 포함한 함대로 구조 신호 스테이지를\n1회 클리어 한다.",
		target_id_2 = "",
		sub_type = 21,
		added_tip = 1,
		story_icon = "u556",
	...
	[6001] = {
		...
		name = "어려움·근해 연습 ",
		count_inherit = 0,
		desc = "어려움·1-1의 모든 작전목표(★3)를 달성하라!",
		target_id_2 = "",
		sub_type = 1021,
		added_tip = 0,
		story_icon = "",
	...
	[6002] = {
		...
		name = "어려움·치욕의 날",
		count_inherit = 0,
		desc = "어려움·1-2의 모든 작전목표(★3)를 달성하라!",
		target_id_2 = "",
		sub_type = 1021,
		added_tip = 0,
		story_icon = "",
	...
	[6003] = {
		...
		name = "어려움·불타오르는 군항",
		count_inherit = 0,
		desc = "어려움·1-3의 모든 작전목표(★3)를 달성하라!",
		target_id_2 = "",
		sub_type = 1021,
		added_tip = 0,
		story_icon = "",
	...
	[6004] = {
		...
		name = "어려움·동쪽에서 온 적",
		count_inherit = 0,
		desc = "어려움·1-4의 모든 작전목표(★3)를 달성하라!",
		target_id_2 = "",
		sub_type = 1021,
		added_tip = 0,
		story_icon = "",
	...
	[6005] = {
		...
		name = "어려움·툴라기섬 지원",
		count_inherit = 0,
		desc = "어려움·2-1의 모든 작전목표(★3)를 달성하라!",
		target_id_2 = "",
		sub_type = 1021,
		added_tip = 0,
		story_icon = "",
	...
	[6006] = {
		...
		award = 6006,
		type = 2,
		name = "어려움·태양에 드리운 먹구름",
		count_inherit = 0,
		desc = "어려움·2-2의 모든 작전목표(★3)를 달성하라!",
		target_id_2 = "",
		sub_type = 1021,
		added_tip = 0,
		story_icon = "",
	...
	[6007] = {
		...
		name = "어려움·출전! 산호해",
		count_inherit = 0,
		desc = "어려움·2-3의 모든 작전목표(★3)를 달성하라!",
		target_id_2 = "",
		sub_type = 1021,
		added_tip = 0,
		story_icon = "",
	...
	[6008] = {
		...
		name = "어려움·구원, 요크타운",
		count_inherit = 0,
		desc = "어려움·2-4의 모든 작전목표(★3)를 달성하라!",
		target_id_2 = "",
		sub_type = 1021,
		added_tip = 0,
		story_icon = "",
	...
	[6009] = {
		...
		name = "어려움·미드웨이 결전!",
		count_inherit = 0,
		desc = "어려움·3-1의 모든 작전목표(★3)를 달성하라!",
		target_id_2 = "",
		sub_type = 1021,
		added_tip = 0,
		story_icon = "",
	...
	[6010] = {
		...
		name = "어려움·운명의 5분 ",
		count_inherit = 0,
		desc = "어려움·3-2의 모든 작전목표(★3)를 달성하라!",
		target_id_2 = "",
		sub_type = 1021,
		added_tip = 0,
		story_icon = "",
	...
	[6011] = {
		...
		name = "어려움·배수의 진",
		count_inherit = 0,
		desc = "어려움·3-3의 모든 작전목표(★3)를 달성하라!",
		target_id_2 = "",
		sub_type = 1021,
		added_tip = 0,
		story_icon = "",
	...
	[6012] = {
		...
		name = "어려움·최후의 반격",
		count_inherit = 0,
		desc = "어려움·3-4의 모든 작전목표(★3)를 달성하라!",
		target_id_2 = "",
		sub_type = 1021,
		added_tip = 0,
		story_icon = "",
	...
	[6013] = {
		...
		name = "어려움·새벽녘의 사신",
		count_inherit = 0,
		desc = "어려움·4-1의 모든 작전목표(★3)를 달성하라!",
		target_id_2 = "",
		sub_type = 1021,
		added_tip = 0,
		story_icon = "",
	...
	[6014] = {
		...
		name = "어려움·피로 물든 새벽",
		count_inherit = 0,
		desc = "어려움·4-2의 모든 작전목표(★3)를 달성하라!",
		target_id_2 = "",
		sub_type = 1021,
		added_tip = 0,
		story_icon = "",
	...
	[6015] = {
		...
		name = "어려움·동솔로몬 조우전",
		count_inherit = 0,
		desc = "어려움·4-3의 모든 작전목표(★3)를 달성하라!",
		target_id_2 = "",
		sub_type = 1021,
		added_tip = 0,
		story_icon = "",
	...
	[6016] = {
		...
		name = "어려움·복수전",
		count_inherit = 0,
		desc = "어려움·4-4의 모든 작전목표(★3)를 달성하라!",
		target_id_2 = "",
		sub_type = 1021,
		added_tip = 0,
		story_icon = "",
	...
	[6017] = {
		...
		name = "어려움·수송 저지 작전",
		count_inherit = 0,
		desc = "어려움·5-1의 모든 작전목표(★3)를 달성하라!",
		target_id_2 = "",
		sub_type = 1021,
		added_tip = 0,
		story_icon = "",
	...
	[6018] = {
		...
		name = "어려움·산타크루즈의 하늘",
		count_inherit = 0,
		desc = "어려움·5-2의 모든 작전목표(★3)를 달성하라!",
		target_id_2 = "",
		sub_type = 1021,
		added_tip = 0,
		story_icon = "",
	...
	[6019] = {
		...
		name = "어려움·호넷의 죽음",
		count_inherit = 0,
		desc = "어려움·5-3의 모든 작전목표(★3)를 달성하라!",
		target_id_2 = "",
		sub_type = 1021,
		added_tip = 0,
		story_icon = "",
	...
	[6020] = {
		...
		name = "어려움·전장에서의 퇴각",
		count_inherit = 0,
		desc = "어려움·5-4의 모든 작전목표(★3)를 달성하라!",
		target_id_2 = "",
		sub_type = 1021,
		added_tip = 0,
		story_icon = "",
	...
	[6021] = {
		...
		name = "어려움·솔로몬의 악몽",
		count_inherit = 0,
		desc = "어려움·6-1의 모든 작전목표(★3)를 달성하라!",
		target_id_2 = "",
		sub_type = 1021,
		added_tip = 0,
		story_icon = "",
	...
	[6022] = {
		...
		name = "어려움·야밤의 대결",
		count_inherit = 0,
		desc = "어려움·6-2의 모든 작전목표(★3)를 달성하라!",
		target_id_2 = "",
		sub_type = 1021,
		added_tip = 0,
		story_icon = "",
	...
	[6023] = {
		...
		name = "어려움·거포 최후의 결전 ",
		count_inherit = 0,
		desc = "어려움·6-3의 모든 작전목표(★3)를 달성하라!",
		target_id_2 = "",
		sub_type = 1021,
		added_tip = 0,
		story_icon = "",
	...
	[6024] = {
		...
		name = "어려움·솔로몬의 결말",
		count_inherit = 0,
		desc = "어려움·6-4의 모든 작전목표(★3)를 달성하라!",
		target_id_2 = "",
		sub_type = 1021,
		added_tip = 0,
		story_icon = "",
	...
	[6025] = {
		...
		name = "어려움·증원 저지",
		count_inherit = 0,
		desc = "어려움·7-1의 모든 작전목표(★3)를 달성하라!",
		target_id_2 = "",
		sub_type = 1021,
		added_tip = 0,
		story_icon = "",
	...
	[6026] = {
		...
		name = "어려움·난전",
		count_inherit = 0,
		desc = "어려움·7-2의 모든 작전목표(★3)를 달성하라!",
		target_id_2 = "",
		sub_type = 1021,
		added_tip = 0,
		story_icon = "",
	...
	[6027] = {
		...
		name = "어려움·기습",
		count_inherit = 0,
		desc = "어려움·7-3의 모든 작전목표(★3)를 달성하라!",
		target_id_2 = "",
		sub_type = 1021,
		added_tip = 0,
		story_icon = "",
	...
	[6028] = {
		...
		name = "어려움·예상 밖의 혼란",
		count_inherit = 0,
		desc = "어려움·7-4의 모든 작전목표(★3)를 달성하라!",
		target_id_2 = "",
		sub_type = 1021,
		added_tip = 0,
		story_icon = "",
	...
	[6029] = {
		...
		name = "어려움·차가운 바람",
		count_inherit = 0,
		desc = "어려움·8-1의 모든 작전목표(★3)를 달성하라!",
		target_id_2 = "",
		sub_type = 1021,
		added_tip = 0,
		story_icon = "",
	...
	[6030] = {
		...
		name = "어려움·북극권의 새벽녘",
		count_inherit = 0,
		desc = "어려움·8-2의 모든 작전목표(★3)를 달성하라!",
		target_id_2 = "",
		sub_type = 1021,
		added_tip = 0,
		story_icon = "",
	...
	[6031] = {
		...
		name = "어려움·빙해의 거친 파도",
		count_inherit = 0,
		desc = "어려움·8-3의 모든 작전목표(★3)를 달성하라!",
		target_id_2 = "",
		sub_type = 1021,
		added_tip = 0,
		story_icon = "",
	...
	[6032] = {
		...
		name = "어려움·잊혀진 전장 ",
		count_inherit = 0,
		desc = "어려움·8-4의 모든 작전목표(★3)를 달성하라!",
		target_id_2 = "",
		sub_type = 1021,
		added_tip = 0,
		story_icon = "",
	...
	[6033] = {
		...
		name = "困难·不祥之夜",
		count_inherit = 0,
		desc = "어려움·9-1의 모든 작전목표(★3)를 달성하라!",
		target_id_2 = "",
		sub_type = 1021,
		added_tip = 0,
		story_icon = "",
	...
	[6034] = {
		...
		name = "困难·拦截作战",
		count_inherit = 0,
		desc = "어려움·9-2의 모든 작전목표(★3)를 달성하라!",
		target_id_2 = "",
		sub_type = 1021,
		added_tip = 0,
		story_icon = "",
	...
	[6035] = {
		...
		name = "困难·黑夜中的光芒",
		count_inherit = 0,
		desc = "어려움·9-3의 모든 작전목표(★3)를 달성하라!",
		target_id_2 = "",
		sub_type = 1021,
		added_tip = 0,
		story_icon = "",
	...
	[6036] = {
		...
		name = "困难·海伦娜",
		count_inherit = 0,
		desc = "어려움·9-4의 모든 작전목표(★3)를 달성하라!",
		target_id_2 = "",
		sub_type = 1021,
		added_tip = 0,
		story_icon = "",
	...
	[10222] = {
		...
		award = 8191,
		type = 26,
		name = "다른 차원의 방문자 - 일상 편 2",
		count_inherit = 0,
		desc = "「데일리 챌린지」임무를 3회 수행하라!",
		target_id_2 = "",
		sub_type = 26,
		added_tip = 1,
		story_icon = "",
	...
	[10224] = {
		...
		award = 8191,
		type = 26,
		name = "다른 차원의 방문자 - 일상 편 4",
		count_inherit = 0,
		desc = "임의의 이벤트 해역을 5번 클리어",
		target_id_2 = "",
		sub_type = 21,
		added_tip = 1,
		story_icon = "",
	...
	[10225] = {
		...
		award = 8191,
		type = 26,
		name = "다른 차원의 방문자 - 일상 편 5",
		count_inherit = 0,
		desc = "전술학원에서 전술훈련을 4번 수행하라!",
		target_id_2 = "",
		sub_type = 71,
		added_tip = 1,
		story_icon = "",
	...
	[10269] = {
		...
		award = 8223,
		type = 26,
		name = "봄바람의 십자성 Day 6.1",
		count_inherit = 0,
		desc = "하드 스테이지를 2회 클리어 한다",
		target_id_2 = "",
		sub_type = 21,
		added_tip = 0,
		story_icon = "",
	...
	[10271] = {
		...
		award = 8223,
		type = 26,
		name = "봄바람의 십자성 Day 7.1",
		count_inherit = 0,
		desc = "적 중요 함대를 3회 격파한다",
		target_id_2 = "",
		sub_type = 21,
		added_tip = 0,
		story_icon = "",
	...
	[10302] = {
		...
		award = 8389,
		type = 2,
		name = "잠수함 착임! 3-4를 클리어",
		count_inherit = 0,
		desc = "잠수함대의 신병이 착임했다! 3-4를 클리어",
		target_id_2 = "",
		sub_type = 1020,
		added_tip = 0,
		story_icon = "",
	...
	[13818] = {
		...
		name = "回流lv<35日常3",
		count_inherit = 0,
		desc = "임의의 메인 스테이지 어려움 모드를 3회 클리어한다.",
		target_id_2 = "",
		sub_type = 21,
		added_tip = 0,
		story_icon = "",
	...
	[13861] = {
		...
		name = "拉新1阶段1",
		count_inherit = 0,
		desc = "라피, 재블린, 아야나미, Z23 중 임의의 함선소녀 레벨 10 달성",
		target_id_2 = "",
		sub_type = 1013,
		added_tip = 0,
		story_icon = "",
	...
	[13862] = {
		...
		name = "拉新1阶段2",
		count_inherit = 0,
		desc = "라피, 재블린, 아야나미, Z23 중 임의의 함선소녀를 한계돌파시켜 ☆3 달성",
		target_id_2 = "",
		sub_type = 33,
		added_tip = 0,
		story_icon = "",
	...
	[13863] = {
		...
		name = "拉新1阶段3",
		count_inherit = 0,
		desc = "라피, 재블린, 아야나미, Z23 중 임의의 함선소녀 레벨 20 달성",
		target_id_2 = "",
		sub_type = 1013,
		added_tip = 0,
		story_icon = "",
	...
	[13864] = {
		...
		name = "拉新1阶段4",
		count_inherit = 0,
		desc = "라피, 재블린, 아야나미, Z23 중 임의의 함선소녀 5회 강화",
		target_id_2 = "",
		sub_type = 34,
		added_tip = 0,
		story_icon = "",
	...
	[13865] = {
		...
		name = "拉新1阶段5",
		count_inherit = 0,
		desc = "라피, 재블린, 아야나미, Z23 중 임의의 함선소녀 10회 강화",
		target_id_2 = "",
		sub_type = 34,
		added_tip = 0,
		story_icon = "",
	...
	[13866] = {
		...
		name = "拉新1阶段6",
		count_inherit = 0,
		desc = "라피, 재블린, 아야나미, Z23 중 임의의 함선소녀 임의의 스킬 레벨 3 달성",
		target_id_2 = "",
		sub_type = 37,
		added_tip = 0,
		story_icon = "",
	...
	[13867] = {
		...
		name = "拉新1阶段7",
		count_inherit = 0,
		desc = "라피, 재블린, 아야나미, Z23 중 임의의 함선소녀 임의의 스킬 레벨 5 달성",
		target_id_2 = "",
		sub_type = 37,
		added_tip = 0,
		story_icon = "",
	...
	[13869] = {
		...
		name = "拉新1阶段9",
		count_inherit = 0,
		desc = "127mm 연장 양용포 MK12 T2를 장비(수동으로 한 번 장비해야 합니다)",
		target_id_2 = "",
		sub_type = 43,
		added_tip = 0,
		story_icon = "",
	...
	[13874] = {
		...
		name = "拉新2阶段1",
		count_inherit = 0,
		desc = "라피, 재블린, 아야나미, Z23 중 임의의 함선소녀 레벨 30 달성",
		target_id_2 = "",
		sub_type = 1013,
		added_tip = 0,
		story_icon = "",
	...
	[13875] = {
		...
		name = "拉新2阶段2",
		count_inherit = 0,
		desc = "라피, 재블린, 아야나미, Z23 중 임의의 함선소녀를 한계돌파시켜 ☆4 달성",
		target_id_2 = "",
		sub_type = 33,
		added_tip = 0,
		story_icon = "",
	...
	[13876] = {
		...
		name = "拉新2阶段3",
		count_inherit = 0,
		desc = "라피, 재블린, 아야나미, Z23 중 임의의 함선소녀 레벨 50 달성",
		target_id_2 = "",
		sub_type = 1013,
		added_tip = 0,
		story_icon = "",
	...
	[13877] = {
		...
		name = "拉新2阶段4",
		count_inherit = 0,
		desc = "라피, 재블린, 아야나미, Z23 중 임의의 함선소녀 레벨 70 달성",
		target_id_2 = "",
		sub_type = 1013,
		added_tip = 0,
		story_icon = "",
	...
	[13882] = {
		...
		name = "拉新2阶段9",
		count_inherit = 0,
		desc = "라피, 재블린, 아야나미, Z23 중 임의의 함선소녀의 임의 스킬 레벨 7 달성",
		target_id_2 = "",
		sub_type = 37,
		added_tip = 0,
		story_icon = "",
	...
	[13886] = {
		...
		name = "拉新2阶段13",
		count_inherit = 0,
		desc = "강화도가 +6인 보라색 레어도 장비를 6개 소지",
		target_id_2 = "6",
		sub_type = 44,
		added_tip = 0,
		story_icon = "",
	...
	[13889] = {
		...
		name = "拉新2阶段16",
		count_inherit = 0,
		desc = "데일리 챌린지에서 장비상자를 누적 20개 획득",
		sub_type = 140,
		added_tip = 0,
		story_icon = "",
		scene = "",
	...
	[13890] = {
		...
		name = "拉新2阶段17",
		count_inherit = 0,
		desc = "데일리 챌린지에서 임의의 부속 누적 30개 획득",
		sub_type = 140,
		added_tip = 0,
		story_icon = "",
		scene = "",
	...
	[13891] = {
		...
		name = "拉新2阶段18",
		count_inherit = 0,
		desc = "데일리 챌린지에서 임의의 교본 누적 20권 획득",
		sub_type = 140,
		added_tip = 0,
		story_icon = "",
		scene = "",
	...
	[13896] = {
		...
		name = "拉新3阶段1",
		count_inherit = 0,
		desc = "라피, 재블린, 아야나미, Z23 중 임의의 함선소녀를 한계돌파시켜 ☆5 달성",
		target_id_2 = "",
		sub_type = 33,
		added_tip = 0,
		story_icon = "",
	...
	[13897] = {
		...
		name = "拉新3阶段2",
		count_inherit = 0,
		desc = "라피, 재블린, 아야나미, Z23 중 임의의 함선소녀 레벨 80 달성",
		target_id_2 = "",
		sub_type = 1013,
		added_tip = 0,
		story_icon = "",
	...
	[13898] = {
		...
		name = "拉新3阶段3",
		count_inherit = 0,
		desc = "라피, 재블린, 아야나미, Z23 중 임의의 함선소녀 레벨 90 달성",
		target_id_2 = "",
		sub_type = 1013,
		added_tip = 0,
		story_icon = "",
	...
	[13899] = {
		...
		name = "拉新3阶段4",
		count_inherit = 0,
		desc = "라피, 재블린, 아야나미, Z23 중 임의의 함선소녀 레벨 100 달성",
		target_id_2 = "",
		sub_type = 1013,
		added_tip = 0,
		story_icon = "",
	...
	[13900] = {
		...
		name = "拉新3阶段5",
		count_inherit = 0,
		desc = "라피, 재블린, 아야나미, Z23 중 임의의 함선소녀 1단계 개조 진행",
		target_id_2 = "",
		sub_type = 1018,
		added_tip = 0,
		story_icon = "",
	...
	[13901] = {
		...
		name = "拉新3阶段6",
		count_inherit = 0,
		desc = "라피, 재블린, 아야나미, Z23 중 임의의 함선소녀 2단계 개조 진행",
		target_id_2 = "",
		sub_type = 1018,
		added_tip = 0,
		story_icon = "",
	...
	[13902] = {
		...
		name = "拉新3阶段7",
		count_inherit = 0,
		desc = "라피, 재블린, 아야나미, Z23 중 임의의 함선소녀 3단계 개조 진행",
		target_id_2 = "",
		sub_type = 1018,
		added_tip = 0,
		story_icon = "",
	...
	[13903] = {
		...
		name = "拉新3阶段8",
		count_inherit = 0,
		desc = "라피, 재블린, 아야나미, Z23 중 임의의 함선소녀 4단계 개조 진행",
		target_id_2 = "",
		sub_type = 1018,
		added_tip = 0,
		story_icon = "",
	...
	[13904] = {
		...
		name = "拉新3阶段9",
		count_inherit = 0,
		desc = "라피, 재블린, 아야나미, Z23 중 임의의 함선소녀 5단계 개조 진행",
		target_id_2 = "",
		sub_type = 1018,
		added_tip = 0,
		story_icon = "",
	...
	[13905] = {
		...
		name = "拉新3阶段10",
		count_inherit = 0,
		desc = "라피, 재블린, 아야나미, Z23 중 임의의 함선소녀 7단계 개조 진행",
		target_id_2 = "",
		sub_type = 1018,
		added_tip = 0,
		story_icon = "",
	...
	[13906] = {
		...
		name = "拉新3阶段11",
		count_inherit = 0,
		desc = "라피, 재블린, 아야나미, Z23 중 임의의 함선소녀 임의 스킬 레벨 9 달성",
		target_id_2 = "",
		sub_type = 37,
		added_tip = 0,
		story_icon = "",
	...
	[13927] = {
		...
		name = "拉新3阶段32",
		count_inherit = 0,
		desc = "데일리 챌린지에서 성정 유닛 누적 800개 획득",
		sub_type = 140,
		added_tip = 0,
		story_icon = "",
		scene = "",
	...
	[13943] = {
		...
		name = "山城礼服皮肤任务13",
		count_inherit = 0,
		desc = "함대를 출격하여, 적의 중요 함대를 3회 격파한다.",
		target_id_2 = "",
		sub_type = 21,
		added_tip = 0,
		story_icon = "",
	...
	[13992] = {
		...
		name = "传颂七日活跃7",
		count_inherit = 0,
		desc = "어려움 난이도 통상 해역 스테이지를 3회 클리어",
		target_id_2 = "",
		sub_type = 21,
		added_tip = 0,
		story_icon = "",
	...
	[14010] = {
		...
		name = "传颂每日任务3",
		count_inherit = 0,
		desc = "어려움 난이도 통상 해역 스테이지를 1회 클리어",
		target_id_2 = "",
		sub_type = 21,
		added_tip = 0,
		story_icon = "",
	...
	[50055] = {
		...
		name = "사랑과 평화의 성야제 7",
		count_inherit = 0,
		desc = "임의의 어려움 난이도 스테이지를 5회 클리어한다.",
		target_id_2 = "",
		sub_type = 21,
		added_tip = 1,
		story_icon = "",
	...
	[50115] = {
		...
		award = 9315,
		type = 36,
		name = "<어둠에 떨어진 푸른 날개>데일리 어려움 난이도",
		count_inherit = 0,
	...
	[60011] = {
		...
		name = "넵튠 연구 개발 착수 임무",
		count_inherit = 0,
		desc = "도감의 로열 네이비 선봉함대 함선 등록 갯수 20 이상",
		target_id_2 = "",
		sub_type = 1040,
		added_tip = 0,
		story_icon = "",
...
――함대를 출격시켜, 로열 네이비 소속 순양함의 누적 획득 경험치를  <color=#92fc63>2000000</color> 축적한다.]],
		target_id_2 = "",
		sub_type = 1041,
		added_tip = 0,
		story_icon = "",
...
――「과학연구」로 임의의 연구 항목을 <color=#92fc63>8회</color> 완료한다.]],
	...
	[60021] = {
		...
		award = 0,
		type = 9,
		name = "모나크 연구 개발 착수 임무",
		count_inherit = 0,
		desc = "도감의 로열 네이비 주력함대 함선 등록 갯수 10 이상",
		target_id_2 = "",
		sub_type = 1040,
		added_tip = 0,
		story_icon = "",
	...
	[60022] = {
		...
		name = "전술 데이터 수집Ⅰ",
		count_inherit = 0,
		desc = "<color=#a2a2a2>개발 작업을 원활히 진행하기 위해서는, 실험 데이터를 충분히 입수하는 것이 대단히 중요하며, 축적된 실전 경험은 그중에서도 제일 효과적일 것이다.</color>\n\n――함대를 출격시켜, 로열 네이비 소속 전함(항공전함, 순양전함 포함)의 누적 획득 경험치를<color=#92fc63>1000000</color> 축적한다.",
		target_id_2 = "",
		sub_type = 1041,
		added_tip = 0,
		story_icon = "",
...
――함대를 출격시켜, 로열 네이비 소속전함(항공전함, 순양전함 포함)의 누적 획득 경험치를 <color=#92fc63>2000000</color>축적한다.]],
		target_id_2 = "",
		sub_type = 1041,
		added_tip = 0,
		story_icon = "",
...
――「과학연구」에서 임의의 연구 항목을 <color=#92fc63>8회</color> 완료한다.]],
	...
	[60028] = {
		...
		name = "함체 건조 I",
		count_inherit = 0,
		desc = "<color=#a2a2a2>오랜 설계 작업이 드디어 완료되었다. 나머지는 함체의 건조뿐! 자, [스페셜 프로젝트] 함선을 완성하도록 하자! 샴페인을 열 준비를 잊지 말도록!</color>\n\n――자금<color=#92fc63> 30000</color>을 수집한다.(「완료」을 터치하면 소모하게 됩니다.)",
		target_id_2 = "",
		sub_type = 1002,
		added_tip = 0,
		story_icon = "",
	...
	[60031] = {
		...
		award = 0,
		type = 9,
		name = "이부키 연구 개발 착수 임무",
		count_inherit = 0,
		desc = "도감의 사쿠라 엠파이어 선봉함대 함선 등록 갯수 20 이상",
		target_id_2 = "",
		sub_type = 1040,
		added_tip = 0,
		story_icon = "",
	...
	[60032] = {
		...
		name = "전술 데이터 수집Ⅰ",
		count_inherit = 0,
		desc = "<color=#a2a2a2>개발 작업을 원활히 진행하기 위해서는, 실험 데이터를 충분히 입수하는 것이 대단히 중요하며, 축적된 실전 경험은 그중에서도 제일 효과적일 것이다.</color>\n\n――함선을 출격시켜, 사쿠라 엠파이어 소속 순양함의 누적 획득 경험치를 <color=#92fc63>1000000</color> 축적한다.",
		target_id_2 = "",
		sub_type = 1041,
		added_tip = 0,
		story_icon = "",
...
――함선을 출격시켜, 사쿠라 엠파이어 소속 순양함의 누적 획득 경험치를 <color=#92fc63> 2000000 </color>축적한다.]],
		target_id_2 = "",
		sub_type = 1041,
		added_tip = 0,
		story_icon = "",
...
――「과학연구」에서 임의의 연구 항목을<color=#92fc63>8회</color>완료한다.]],
	...
	[60037] = {
		...
		name = "초월 기술 설계Ⅱ",
		count_inherit = 0,
		desc = "<color=#a2a2a2>기술 이론과 실전 데이터, 견실한 설계와 대담한 발상으로 조합된 [스페셜 프로젝트] 함선의 설계가 드디어 거의 완성되었다. 나머지 문제점을 해결하고, 최고의 완성도를 목표로 하자.</color>\n\n――순양함 개조 도면 T3을<color=#92fc63> 5장 </color>수집한다.(「완료」을 터치하면 소모하게 됩니다.)",
		target_id_2 = "",
		sub_type = 1000,
		added_tip = 0,
		story_icon = "",
	...
	[60038] = {
		...
		name = "함체 건조 I",
		count_inherit = 0,
		desc = "<color=#a2a2a2>오랜 설계 작업이 드디어 완료되었다. 나머지는 함체의 건조뿐! 자, [스페셜 프로젝트] 함선을 완성하도록 하자! 샴페인을 열 준비를 잊지 말도록!</color>\n\n――물자<color=#92fc63> 20000</color>을 수집한다.(「완료」을 터치하면 소모하게 됩니다.)",
		target_id_2 = "",
		sub_type = 1002,
		added_tip = 0,
		story_icon = "",
	...
	[60041] = {
		...
		award = 0,
		type = 9,
		name = "이즈모 연구 개발 착수 임무",
		count_inherit = 0,
		desc = "도감의 사쿠라 엠파이어 주력함대 함선 등록 갯수 10 이상",
		target_id_2 = "",
		sub_type = 1040,
		added_tip = 0,
		story_icon = "",
	...
	[60042] = {
		...
		name = "전술 데이터 수집Ⅰ",
		count_inherit = 0,
		desc = "<color=#a2a2a2>개발 작업을 원활히 진행하기 위해서는, 실험 데이터를 충분히 입수하는 것이 대단히 중요하며, 축적된 실전 경험은 그중에서도 제일 효과적일 것이다.</color>\n\n――함선을 출격시켜, 사쿠라 엠파이어 소속 전함(항공전함, 순양전함 포함)의 누적 획득 경험치를 <color=#92fc63> 1000000 </color>축적한다.",
		target_id_2 = "",
		sub_type = 1041,
		added_tip = 0,
		story_icon = "",
	...
	[60044] = {
		...
		name = "초월 기술 설계Ⅰ",
		count_inherit = 0,
		desc = "<color=#a2a2a2>전술 데이터에 따른 피드백과 최첨단 기술 이론을 결합한 결과, 개발은 도면 제작 단계까지 진행될 수 있었다. 하지만, 설계의 세부 항목을 마저 완성시키기 위해선 기존의 도면 설계와의 비교를 철저히 진행할 수 밖에 없다.</color>\n\n――전함 개조 도면 T2 를<color=#92fc63> 10장 </color>수집한다.(「완료」을 터치하면 소모하게 됩니다.)",
		target_id_2 = "",
		sub_type = 1000,
		added_tip = 0,
		story_icon = "",
...
――함선을 출격시켜, 사쿠라 엠파이어 소속 전함(항공전함, 순양전함 포함)의 누적 획득 경험치를 <color=#92fc63>2000000</color>축적한다.]],
		target_id_2 = "",
		sub_type = 1041,
		added_tip = 0,
		story_icon = "",
...
――「과학연구」에서 임의의 연구 항목을<color=#92fc63> 8회 </color>완료한다.]],
	...
	[60051] = {
		...
		name = "론 연구 개발 착수 임무",
		count_inherit = 0,
		desc = "도감의 메탈 블러드 선봉함대 함선 등록 갯수 7 이상",
		target_id_2 = "",
		sub_type = 1040,
		added_tip = 0,
		story_icon = "",
	...
	[60052] = {
		...
		name = "전술 데이터 수집Ⅰ",
		count_inherit = 0,
		desc = "<color=#a2a2a2>개발 작업을 원활히 진행하기 위해서는, 실험 데이터를 충분히 입수하는 것이 대단히 중요하며, 축적된 실전 경험은 그중에서도 제일 효과적일 것이다.</color>\n\n――함선을 출격시켜, 메탈 블러드 소속 순양함의 누적 획득 경험치를  <color=#92fc63>1000000</color> 축적한다.",
		target_id_2 = "",
		sub_type = 1041,
		added_tip = 0,
		story_icon = "",
...
――함선을 출격시켜, 메탈 블러드 소속 순양함의 누적 획득 경험치를 <color=#92fc63> 2000000 </color>축적한다.]],
		target_id_2 = "",
		sub_type = 1041,
		added_tip = 0,
		story_icon = "",
...
――「과학연구」에서 임의의 연구 항목을<color=#92fc63> 8회 </color>완료한다.]],
	...
	[60061] = {
		...
		award = 0,
		type = 9,
		name = "생 루이 연구 개발 착수 임무",
		count_inherit = 0,
		desc = "도감의 이글 유니온 선봉함대 함선 등록 갯수 20 이상",
		target_id_2 = "",
		sub_type = 1040,
		added_tip = 0,
		story_icon = "",
	...
	[60062] = {
		...
		name = "전술 데이터 수집Ⅰ",
		count_inherit = 0,
		desc = "<color=#a2a2a2>개발 작업을 원활히 진행하기 위해서는, 실험 데이터를 충분히 입수하는 것이 대단히 중요하며, 축적된 실전 경험은 그중에서도 제일 효과적일 것이다.</color>\n\n――함선을 출격시켜, 이글 유니온 소속 순양함의 누적 획득 경험치를 <color=#92fc63>1000000</color>축적한다.",
		target_id_2 = "",
		sub_type = 1041,
		added_tip = 0,
		story_icon = "",
...
――함선을 출격시켜, 이글 유니온 소속 순양함의 누적 획득 경험치를 <color=#92fc63> 2000000 </color>축적한다.]],
		target_id_2 = "",
		sub_type = 1041,
		added_tip = 0,
		story_icon = "",
...
――「과학연구」에서 임의의 연구 항목을<color=#92fc63> 8회 </color>완료한다.]],
	...
	[60069] = {
		...
		name = "함체 건조 Ⅱ",
		count_inherit = 0,
		desc = "<color=#a2a2a2>오랜 설계 작업이 드디어 완료되었다. 나머지는 함체의 건조뿐! 자, [스페셜 프로젝트] 함선을 완성하도록 하자! 샴페인을 열 준비를 잊지 말도록!</color>\n\n――성정 큐브<color=#92fc63> 5개</color>을 수집한다.(「완료」을 터치하면 소모하게 됩니다.)",
		target_id_2 = "",
		sub_type = 1000,
		added_tip = 0,
		story_icon = "",
...
――「과학연구」에서 임의의 연구 항목을<color=#92fc63> 8회 </color>완료한다.]],
	...
	[60094] = {
		...
		name = "초월 기술 설계Ⅰ",
		count_inherit = 0,
		desc = "<color=#a2a2a2>전술 데이터에 따른 피드백과 최첨단 기술 이론을 결합한 결과, 개발은 도면 제작 단계까지 진행될 수 있었다. 하지만, 설계의 세부 항목을 마저 완성시키기 위해선 기존의 도면 설계와의 비교를 철저히 진행할 수 밖에 없다.</color>\n\n――구축함 개조 도면 T2 를<color=#92fc63> 10장 </color>수집한다.(「완료」을 터치하면 소모하게 됩니다.)",
		target_id_2 = "",
		sub_type = 1000,
		added_tip = 0,
		story_icon = "",
...
――「과학연구」에서 임의의 연구 항목을<color=#92fc63> 8회 </color>완료한다.]],
	...
	[60097] = {
		...
		name = "초월 기술 설계Ⅱ",
		count_inherit = 0,
		desc = "<color=#a2a2a2>기술 이론과 실전 데이터, 견실한 설계와 대담한 발상으로 조합된 [스페셜 프로젝트] 함선의 설계가 드디어 거의 완성되었다. 나머지 문제점을 해결하고, 최고의 완성도를 목표로 하자.</color>\n\n――구축함 개조 도면 T3을 <color=#92fc63> 5장 </color>수집한다.(「완료」을 터치하면 소모하게 됩니다.)",
		target_id_2 = "",
		sub_type = 1000,
		added_tip = 0,
		story_icon = "",
...
――「과학연구」에서 임의의 연구 항목을<color=#92fc63> 12회 </color>완료한다.]],
	...
	[60117] = {
		...
		name = "초월 기술 설계Ⅱ",
		count_inherit = 0,
		desc = "<color=#a2a2a2>기술 이론과 실전 데이터, 견실한 설계와 대담한 발상으로 조합된 [스페셜 프로젝트] 함선의 설계가 드디어 거의 완성되었다. 나머지 문제점을 해결하고, 최고의 완성도를 목표로 하자.</color>\n\n――전함 개조 도면 T3을 <color=#92fc63> 8장 </color>수집한다.(「완료」을 터치하면 소모하게 됩니다.)",
		target_id_2 = "",
		sub_type = 1000,
		added_tip = 0,
		story_icon = "",
	...
	[60118] = {
		...
		name = "함체 건조 I",
		count_inherit = 0,
		desc = "<color=#a2a2a2>오랜 설계 작업이 드디어 완료되었다. 나머지는 함체의 건조뿐! 자, [스페셜 프로젝트] 함선을 완성하도록 하자! 샴페인을 열 준비를 잊지 말도록!</color>\n\n――물자<color=#92fc63> 60000</color>을 수집한다.(「완료」을 터치하면 소모하게 됩니다.)",
		target_id_2 = "",
		sub_type = 1002,
		added_tip = 0,
		story_icon = "",
	...
	[60122] = {
		...
		name = "전술 데이터 수집Ⅰ",
		count_inherit = 0,
		desc = "<color=#a2a2a2>개발 작업을 원활히 진행하기 위해서는, 실험 데이터를 충분히 입수하는 것이 대단히 중요하며, 축적된 실전 경험은 그중에서도 제일 효과적일 것이다.</color>\n\n―― 함선을 출격시켜, 메탈 블러드、아이리스 리브레、비시아 큐리아 소속 주력 함선의 누적 획득 경험치를 <color=#92fc63> 1000000 </color>축적한다.",
		target_id_2 = "",
		sub_type = 1041,
		added_tip = 0,
		story_icon = "",
...
――함선을 출격시켜, 메탈 블러드、아이리스 리브레、비시아 큐리아 소속 주력 함선의 누적 획득 경험치를 <color=#92fc63> 2000000 </color>축적한다.]],
		target_id_2 = "",
		sub_type = 1041,
		added_tip = 0,
		story_icon = "",
