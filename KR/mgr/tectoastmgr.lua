...
pg.TecToastMgr.Ctor = function (slot0)
	slot0._go = nil
end

pg.TecToastMgr.Init = function (slot0, slot1)
...
pg.TecToastMgr.findUI = function (slot0)
...
pg.TecToastMgr.tryShow = function (slot0, slot1, slot2, slot3, slot4)
...
pg.TecToastMgr.Show = function (slot0, slot1, slot2, slot3, slot4)
	slot0.itemList = {}
...
pg.TecToastMgr.itemFunc = function (slot0, slot1, slot2, slot3)
...
pg.TecToastMgr.onLast = function (slot0)
