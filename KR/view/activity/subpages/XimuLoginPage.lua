slot0 = class("Day7LoginPage", import(".TemplatePage.LoginTemplatePage"))
...
function slot0.OnUpdateFlush(slot0)
	...
	eachChild(slot0.items, function (slot0)
		setText(uv0:findTF("day/Text", slot0), setColorStr(getText(slot1), slot0:GetSiblingIndex() < uv0.nday and COLOR_GREY or COLOR_WHITE))
	end)
