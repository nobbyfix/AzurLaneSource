...
function slot0.showItemDetail(slot0, slot1)
	...
	if slot0.detailContain then
		...
		-- Decompilation error in this vicinity:
		--- BLOCK #0 181-288, warpins: 1 ---
		SetActive(slot0.normal, slot10)

		if slot10 then

			-- Decompilation error in this vicinity:
			--- BLOCK #0 187-219, warpins: 1 ---
