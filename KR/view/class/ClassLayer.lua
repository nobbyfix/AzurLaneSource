...
function slot0.updateResourcePanel(slot0)
	...
	if slot0.resClass.GetLevel(slot4) == slot5.all[#slot5.all] then
		...
		slot0:setBar(slot0.resourcePanel:Find("frame/content/info/store"), slot5[slot0.resClass.GetLevel(slot4)].store, 0, slot5[slot5.all[#slot5.all]].store)
		slot0:setBar(slot0.resourcePanel:Find("frame/content/info/rate"), slot5[slot0.resClass.GetLevel(slot4)].proficency_get_percent, 0, slot5[slot5.all[#slot5.all]].proficency_get_percent, "%")
		slot0:setBar(slot0.resourcePanel:Find("frame/content/info/exp"), slot5[slot0.resClass.GetLevel(slot4)].proficency_cost_per_min * 60, 0, slot5[slot5.all[#slot5.all]].proficency_cost_per_min * 60, "/h")
		--- END OF BLOCK #0 ---
