...
function slot3.DoPrologue(slot0)
	...
	slot0._uiMediator:SeaSurfaceShift(45, 0, nil, function ()
		uv0._uiMediator:OpeningEffect(function ()
			...
			uv0._state:GetCommandByName(uv1.Battle.BattleControllerWeaponCommand.__name).TryAutoSub(slot0)
...
function slot3.onWillDie(slot0, slot1)
	if slot1.Dispatcher.GetDeathReason(slot2) ~= uv0.Battle.BattleConst.UnitDeathReason.LEAVE then
