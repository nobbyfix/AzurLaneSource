...
function slot2.Init(slot0, slot1)
	slot0._allPool = {}
	slot0._ob2Pool = {}
	slot0._allPool[uv0.HP_BAR_FRIENDLY] = uv0.generatePool(uv0.HP_BAR_FRIENDLY, slot1, slot1, 3, 10)
	slot0._allPool[uv0.HP_BAR_FOE] = uv0.generatePool(uv0.HP_BAR_FOE, slot1, slot1, 8, 10)
end
