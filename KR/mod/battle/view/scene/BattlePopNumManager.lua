...
function slot2.Init(slot0, slot1, slot2)
	slot0._allPool = {}
	slot0._activeList = {}
	slot0._allPool[uv0.POP_COMMON] = slot0:generatePool(uv0.POP_COMMON, slot2, slot1, 10)
	slot0._allPool[uv0.POP_MISS] = slot0:generatePool(uv0.POP_MISS, slot2, slot1, 10)
	slot0._allPool[uv0.POP_UNBREAK] = slot0:generatePool(uv0.POP_UNBREAK, slot2, slot1, 10)
	slot0._allPool[uv0.POP_HEAL] = slot0:generatePool(uv0.POP_HEAL, slot2, slot1, 0)
	slot0._allPool[uv0.POP_NORMAL] = slot0:generatePool(uv0.POP_NORMAL, slot2, slot1, 0)
	slot0._allPool[uv0.POP_EXPLO] = slot0:generatePool(uv0.POP_EXPLO, slot2, slot1, 0)
	slot0._allPool[uv0.POP_PIERCE] = slot0:generatePool(uv0.POP_PIERCE, slot2, slot1, 0)
	slot0._allPool[uv0.POP_CT_NORMAL] = slot0:generatePool(uv0.POP_CT_NORMAL, slot2, slot1, 0)
	slot0._allPool[uv0.POP_CT_EXPLO] = slot0:generatePool(uv0.POP_CT_EXPLO, slot2, slot1, 0)
	slot0._allPool[uv0.POP_CT_PIERCE] = slot0:generatePool(uv0.POP_CT_PIERCE, slot2, slot1, 0)
end

function slot2.InitScroePop(slot0, slot1, slot2)
	slot0._allPool[uv0.POP_SCORE] = slot0:generatePool(uv0.POP_SCORE, slot2, slot1, 5)
end
...
function slot2.GetPop(slot0, slot1, slot2, slot3, slot4, slot5)
	...
	if slot6 ~= uv0.POP_MISS then
		slot0._allPool[slot6].GetObject(slot8):SetText(slot4)
	end
...
function slot2.GetScorePop(slot0, slot1)
	slot3 = slot0._allPool[uv0.POP_SCORE].GetObject(slot2)
...
function slot2.getType(slot0, slot1, slot2, slot3)
	...
	elseif slot3 then
		slot7 = slot3[2]
		slot5 = (not slot1 or uv0.CTFontIndex[slot3[1]]) and uv0.FontIndex[slot3[1]]
		slot4 = slot3[2]
	else
