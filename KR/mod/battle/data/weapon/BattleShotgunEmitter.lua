...
function slot3.GenerateBullet(slot0)
	...
	slot0._spawnFunc(slot0._convertedDirBarrage[slot0._primalCounter].OffsetX, slot1.OffsetZ, slot0._isRandomAngle and (uv0.random() - 0.5) * uv0.random(slot0._angleRange) - slot0._angleRange / 2 or uv0.random(slot0._angleRange) - slot0._angleRange / 2, slot0._offsetPriority, slot0._target, slot0._primalCounter)
	slot0:Interation()
end
