...
slot8.AddPreCastTimer = function (slot0)
	...
	slot0._precastTimer = pg.TimeMgr.GetInstance():AddBattleTimer("", 0, slot1.AntiAirConfig.Precast_duration, slot1, true)
end
...
slot8.Fire = function (slot0)
	...
	slot0._dataProxy:SpawnColumnArea(slot1.AOEField.AIR, slot0._host:GetIFF(), slot0._host:GetPosition(), slot0._range * 2, -1, slot1)
	slot0:EnterCoolDown()
