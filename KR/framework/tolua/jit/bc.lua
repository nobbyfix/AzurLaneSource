...
return {
	line = function (slot0, slot1, slot2)
		...
		if uv1(slot4, 1920) == 1664 then
			return uv5("%s=> %04d\n", uv5("%04d %s %-6s %3s ", slot1, slot2 or "  ", uv3(uv4, 6 * uv1(slot3, 255) + 1, 6 * uv1(slot3, 255) + 6), uv1(slot4, 7) == 0 and "" or uv1(uv2(slot3, 8), 255)), slot1 + uv2(slot3, 16) - 32767)
		end
		...
		if slot5 == 5 then
			slot13 = slot13 and uv11(slot0, slot8) .. " ; " .. slot13 or uv11(slot0, slot8)
		end
