...
function slot35(slot0)
	slot8, slot9, slot10, slot10 = uv0(slot0.code, slot0.pos + 1, slot0.pos + 4)
...
function slot37(slot0)
	...
	for slot12 in uv6(slot6, ".") do
		...
		elseif slot12 == "B" then
			slot0.rel = slot0.addr + slot0.pos + uv8(uv9(slot1, 16), 16) * 4 + 4
			slot13 = uv10("0x%08x", slot0.addr + slot0.pos + uv8(uv9(slot1, 16), 16) * 4 + 4)
		elseif slot12 == "J" then
			slot0.rel = slot0.addr + slot0.pos - uv4(slot14, 268435455) + uv4(slot1, 67108863) * 4
			slot13 = uv10("0x%08x", slot0.addr + slot0.pos - uv4(slot14, 268435455) + uv4(slot1, 67108863) * 4)
...
function slot38(slot0, slot1, slot2)
	slot3 = (slot2 and (slot1 or 0) + slot2 or #slot0.code) - (slot2 and (slot1 or 0) + slot2 or #slot0.code) % 4
