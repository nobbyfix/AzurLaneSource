...
()["__index"].receivestatusline = function (slot0)
	...
	return slot0.try(uv2.tonumber(slot2), slot0.try(slot0.c:receive("*l", slot1)))
end
...
()["__index"].receive09body = function (slot0, slot1, slot2, slot3)
	...
	return slot0.try(uv0.pump.all(uv0.source.rewind(uv1.source("until-closed", slot0.c)), slot2, slot3))
end
...
function slot14(slot0)
	if slot0.proxy or uv0.PROXY then
		return uv1.parse(slot1).host, uv1.parse(slot1).port or 3128
	else
...
function slot23(slot0, slot1)
	...
	return uv2.concat(uv0(slot0, slot1).target), slot4, slot5, slot6
end
