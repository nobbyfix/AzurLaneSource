...
slot5.grayscale = ({
	...
	Lerp = function (slot0, slot1, slot2)
		return uv1.New(slot0.r + uv0.Clamp01(slot2) * (slot1.r - slot0.r), slot0.g + uv0.Clamp01(slot2) * (slot1.g - slot0.g), slot0.b + uv0.Clamp01(slot2) * (slot1.b - slot0.b), slot0.a + uv0.Clamp01(slot2) * (slot1.a - slot0.a))
	end,
	...
	HSVToRGB = function (slot0, slot1, slot2, slot3)
		...
		slot4.g = 0
		slot4.b = 0
		slot12 = slot2 * (1 - slot1 * (1 - (slot0 * 6 - uv1.Floor(slot7))))

		if uv1.Floor(slot7) + 1 == 0 then
			slot4.r = slot6
			slot4.g = slot2 * (1 - slot1)
			slot4.b = slot2 * (1 - slot1 * (slot0 * 6 - uv1.Floor(slot7)))
